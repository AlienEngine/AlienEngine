...
namespace AlienEngine.Core.Rendering.Fonts
{
    class FontData
    {
        ...
        /// <returns></returns>
        public int GetKerningPairCorrection(int index, string text, FontTextNode textNode)
        {
            ...
            {
                if (textNode != null && textNode.Next != null && textNode.Next.Type == FontTextNodeType.Word)

...
using AlienEngine.Core.Physics.DeactivationManagement;
...
namespace AlienEngine.Core.Physics.Entities
{
    ///<summary>
    ...
    public class Entity :
        ...
        IForceUpdateable,
        ISpaceObject,
        IPhysicsMaterialOwner,
        ICollisionRulesOwner,
        IEquatable<Entity>
    {
        internal Vector3f position;
        internal Quaternion orientation = Quaternion.Identity;
        internal Matrix3f orientationMatrix = Matrix3f.Identity;
        internal Vector3f linearVelocity;
        internal Vector3f angularVelocity;
#if CONSERVE
        internal Vector3f angularMomentum;
#endif
        ...
        /// </summary>
        public Matrix3f OrientationMatrix
        {
            get
            {
            ...
            set
            {
                Quaternion.FromRotationMatrix(ref value, out orientation);
        ...
        public Matrix4f WorldTransform
        {
            get
            {
                ...
                Matrix3f.ToMatrix4f(ref orientationMatrix, out worldTransform);
...
#if CONSERVE
                Matrix3f.Transform(ref value, ref inertiaTensor, out angularMomentum);
        ...
        public Vector3f AngularMomentum
        {
...
#else
                Vector3f v;
                Vector3f.Transform(ref angularVelocity, ref inertiaTensor, out v);
                return v;
#endif
            }
            set
            {
                ...
                MathChecker.Validate(angularMomentum);
#else
                Vector3f.Transform(ref value, ref inertiaTensorInverse, out angularVelocity);
                activityInformation.Activate();
#endif
                MathChecker.Validate(angularVelocity);
            }
        ...
        /// </summary>
        public Vector3f LinearMomentum
        {
            get
            {
                Vector3f momentum;
                Vector3f.Multiply(ref linearVelocity, mass, out momentum);
                return momentum;
            }
            set
            {
                Vector3f.Multiply(ref value, inverseMass, out linearVelocity);
                activityInformation.Activate();
        ...
        private Vector3f personalGravity;
        ///<summary>
        ...
        internal Matrix3f inertiaTensorInverse;
        ///<summary>
        /// Gets the world space inertia tensor inverse of the entity.
        ///</summary>
        public Matrix3f InertiaTensorInverse
        {
            get
            {
        ...
        internal Matrix3f inertiaTensor;
        ///<summary>
        ...
        internal Matrix3f localInertiaTensor;
        ///<summary>
        ...
        public Matrix3f LocalInertiaTensor
        {
            ...
            set
            {
                ...
                Matrix3f.AdaptiveInvert(ref localInertiaTensor, out localInertiaTensorInverse);
                Matrix3f multiplied;
                Matrix3f.MultiplyTransposed(ref orientationMatrix, ref localInertiaTensorInverse, out multiplied);
                Matrix3f.Multiply(ref multiplied, ref orientationMatrix, out inertiaTensorInverse);
                Matrix3f.MultiplyTransposed(ref orientationMatrix, ref localInertiaTensor, out multiplied);
        ...
        internal Matrix3f localInertiaTensorInverse;
        /// <summary>
        /// Gets or sets the local inertia tensor inverse of the entity.
        /// </summary>
        public Matrix3f LocalInertiaTensorInverse
        {
            get
            {
            ...
            set
            {
                ...
                Matrix3f.AdaptiveInvert(ref localInertiaTensorInverse, out localInertiaTensor);
            ...
            set
            {
                ...
                else
                {
                    if (isDynamic)
                    {
                        ...
                        Matrix3f newInertia;
                        Matrix3f.Multiply(ref localInertiaTensor, value * inverseMass, out newInertia);
        ...
        Action<PhysicsMaterial> materialChangedDelegate;
        ...
        public Entity(EntityCollidable collisionInformation, float mass, Matrix3f inertiaTensor)
            : this()
        {
        ...
        ///<param name="mass">Mass of the entity. If positive, the entity will be dynamic. Otherwise, it will be kinematic.</param>
        /// <param name="inertiaTensor">Inertia tensor of the entity. Only used for a dynamic entity.</param>
        public Entity(EntityShape shape, float mass, Matrix3f inertiaTensor)
            : this()
        {
        ...
        protected internal void Initialize(EntityCollidable collisionInformation, float mass, Matrix3f inertiaTensor)
        {
            CollisionInformation = collisionInformation;
        ...
        public void ApplyImpulse(Vector3f location, Vector3f impulse)
        {
        ...
        ///<param name="location">Location to apply the impulse.</param>
        ///<param name="impulse">Impulse to apply.</param>
        public void ApplyImpulse(ref Vector3f location, ref Vector3f impulse)
        {
            if (isDynamic)
            {
        ...
        ///<param name="location">Location to apply the impulse.</param>
        ///<param name="impulse">Impulse to apply.</param>
        public void ApplyImpulseWithoutActivating(ref Vector3f location, ref Vector3f impulse)
        {
            ApplyLinearImpulse(ref impulse);
#if WINDOWS
            Vector3f positionDifference;
#else
            Vector3f positionDifference = new Vector3f();
#endif
            ...
            Vector3f cross;
            Vector3f.Cross(ref positionDifference, ref impulse, out cross);
        ...
        public void BecomeDynamic(float mass, Matrix3f localInertiaTensor)
        {

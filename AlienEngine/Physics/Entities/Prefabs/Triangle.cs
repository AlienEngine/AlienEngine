...
namespace AlienEngine.Core.Physics.Entities.Prefabs
{
    ...
    public class Triangle : Entity<ConvexCollidable<TriangleShape>>
    {
        ...
        public Vector3f VertexA
        {
            get
            {
                return Vector3f.Transform(CollisionInformation.Shape.VertexA, orientationMatrix) + position;
            }
            set
            {
                CollisionInformation.Shape.VertexA = Vector3f.TransformTranspose(value - position, orientationMatrix);
            }
        }
        ///<summary>
        ...
        public Vector3f VertexB
        {
            get
            {
                return Vector3f.Transform(CollisionInformation.Shape.VertexB, orientationMatrix) + position;
            }
            set
            {
                CollisionInformation.Shape.VertexB = Vector3f.TransformTranspose(value - position, orientationMatrix);
            }
        }
        ///<summary>
        ...
        public Vector3f VertexC
        {
            get
            {
                return Vector3f.Transform(CollisionInformation.Shape.VertexC, orientationMatrix) + position;
            }
            set
            {
                CollisionInformation.Shape.VertexC = Vector3f.TransformTranspose(value - position, orientationMatrix);
            }
        }
        ...
        public Triangle(Vector3f v1, Vector3f v2, Vector3f v3, float mass)
        {
            Vector3f center;
        ...
        /// <param name="v3">Position of the third vertex.</param>
        /// <param name="mass">Mass of the object.</param>
        public Triangle(Vector3f pos, Vector3f v1, Vector3f v2, Vector3f v3, float mass)
            : this(v1, v2, v3, mass)
        {
            Position = pos;
        }
        ...
        /// <param name="v2">Position of the second vertex.</param>
        /// <param name="v3">Position of the third vertex.</param>
        public Triangle(Vector3f pos, Vector3f v1, Vector3f v2, Vector3f v3)
            : this(v1, v2, v3)
        {
            Position = pos;
        }
        ...
        /// <param name="v3">Position of the third vertex.</param>
        /// <param name="mass">Mass of the object.</param>
        public Triangle(MotionState motionState, Vector3f v1, Vector3f v2, Vector3f v3, float mass)
            : this(v1, v2, v3, mass)
        {
        ...
        /// <param name="v2">Position of the second vertex.</param>
        /// <param name="v3">Position of the third vertex.</param>
        public Triangle(MotionState motionState, Vector3f v1, Vector3f v2, Vector3f v3)
            : this(v1, v2, v3)
        {
            MotionState = motionState;
        }

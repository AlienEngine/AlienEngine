...
namespace AlienEngine.Core.Physics.Entities
{
    ...
    public class MorphableEntity : Entity
    {
        ...
        public MorphableEntity(EntityCollidable collisionInformation, float mass, Matrix3f inertiaTensor)
        ...
        public void SetCollisionInformation(EntityCollidable newCollisionInformation, float newMass, Matrix3f newInertia)
        {
            //Temporarily remove the object from the space.  
            //The reset process will update any systems that need to be updated.
            //This is not thread safe, but this operation should not be performed mid-frame anyway.

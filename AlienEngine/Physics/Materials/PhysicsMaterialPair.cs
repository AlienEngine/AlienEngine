...
namespace AlienEngine.Core.Physics.Materials
{
    ...
    /// A pair of materials.
    ///</summary>
    public struct PhysicsMaterialPair :IEquatable<PhysicsMaterialPair>
    {
        ///<summary>
        /// First material in the pair.
        ///</summary>
        public PhysicsMaterial MaterialA;
        ///<summary>
        /// Second material in the pair.
        ///</summary>
        public PhysicsMaterial MaterialB;
        ///<summary>
        ...
        public PhysicsMaterialPair(PhysicsMaterial a, PhysicsMaterial b)
        {
            MaterialA = a;
            MaterialB = b;
        }
        ...
        public bool Equals(PhysicsMaterialPair other)
        {

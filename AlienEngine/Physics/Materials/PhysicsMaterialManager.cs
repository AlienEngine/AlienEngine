...
namespace AlienEngine.Core.Physics.Materials
{
    ...
    public delegate void PhysicsMaterialBlender(PhysicsMaterial a, PhysicsMaterial b, out InteractionProperties properties);

    ///<summary>
    /// Manages the relationship between materials.
    ///</summary>
    public static class PhysicsMaterialManager
    {
        /// <summary>
        ...
        /// </summary>
        public static PhysicsMaterialBlender MaterialBlender = DefaultMaterialBlender;
        ...
        static PhysicsMaterialManager()
        {
            MaterialInteractions = new Dictionary<PhysicsMaterialPair, PhysicsMaterialBlender>();
        }
        ...
        public static void GetInteractionProperties(PhysicsMaterial materialA, PhysicsMaterial materialB, out InteractionProperties properties)
        {
            PhysicsMaterialBlender specialBlender;
            if (MaterialInteractions.TryGetValue(new PhysicsMaterialPair(materialA, materialB), out specialBlender))
        ...
        ///</summary>
        public static Dictionary<PhysicsMaterialPair, PhysicsMaterialBlender> MaterialInteractions { get; set; }
        ...
        public static void DefaultMaterialBlender(PhysicsMaterial a, PhysicsMaterial b, out InteractionProperties properties)
        {

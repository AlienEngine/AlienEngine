...
namespace AlienEngine.Core.Physics.Materials
{
    ...
    {
        internal float kineticFriction = PhysicsMaterialManager.DefaultKineticFriction;
        ///<summary>
        ...
        internal float staticFriction = PhysicsMaterialManager.DefaultStaticFriction;
        ///<summary>
        ...
        internal float bounciness = PhysicsMaterialManager.DefaultBounciness;
        ///<summary>
        ...
        public PhysicsMaterial(float staticFriction, float kineticFriction, float bounciness)
            : this()
        {
        ...
        ///</summary>
        public event Action<PhysicsMaterial> MaterialChanged;

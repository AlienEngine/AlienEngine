...
namespace AlienEngine.Core.Physics.Paths
{
    ...
    public class VariableLinearSpeedCurve : VariableSpeedCurve<Vector3f>
    {
        /// <summary>
        ...
        public VariableLinearSpeedCurve(Path<float> speedCurve, Curve<Vector3f> curve)
        ...
        public VariableLinearSpeedCurve(Path<float> speedCurve, Curve<Vector3f> curve, int sampleCount)

...
namespace AlienEngine.Core.Physics.Paths
{
    ...
    /// </summary>
    public class LinearInterpolationCurve3D : Curve<Vector3f>
    {
        /// <summary>
        ...
        public override void Evaluate(int controlPointIndex, float weight, out Vector3f value)
        {
            value = Vector3f.Lerp(ControlPoints[controlPointIndex].Value, ControlPoints[controlPointIndex + 1].Value, weight);
        }
        ...
        protected internal override void ControlPointAdded(CurveControlPoint<Vector3f> curveControlPoint, int index)
        {
        }
        ...
        protected internal override void ControlPointRemoved(CurveControlPoint<Vector3f> curveControlPoint, int oldIndex)
        {
        }
        ...
        protected internal override void ControlPointTimeChanged(CurveControlPoint<Vector3f> curveControlPoint, int oldIndex, int newIndex)
        {
        }
        ...
        /// </summary>
        /// <param name="curveControlPoint">Changed control point.</param>
        protected internal override void ControlPointValueChanged(CurveControlPoint<Vector3f> curveControlPoint)
        {
        }
        ...
        //public override void evaluate(double time, out Vector3f value)
        //{
        ...
        //    value = Vector3f.Lerp(controlPoints[index].value, controlPoints[nextIndex].value, intervalTime); 

...
namespace AlienEngine.Core.Physics.Paths
{
    ...
    /// </summary>
    public abstract class HermiteCurve3D : Curve<Vector3f>
    {
        /// <summary>
        /// Internal list of curve tangents.
        /// </summary>
        protected List<Vector3f> tangents = new List<Vector3f>();


        /// <summary>
        /// Gets the tangents used by the curve per control point.
        /// </summary>
        public ReadOnlyList<Vector3f> Tangents
        {
            get
            {
                return new ReadOnlyList<Vector3f>(tangents);
            }
        }

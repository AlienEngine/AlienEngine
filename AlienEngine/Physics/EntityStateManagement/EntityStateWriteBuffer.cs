...
namespace AlienEngine.Core.Physics.EntityStateManagement
{
    ...
    public class EntityStateWriteBuffer : ProcessingStage
    {
        ...
        public void EnqueuePosition(Entity entity, ref Vector3f newPosition)
        {
        ...
        public void EnqueueLinearVelocity(Entity entity, ref Vector3f newLinearVelocity)
        {
        ...
        public void EnqueueAngularVelocity(Entity entity, ref Vector3f newAngularVelocity)
        {

namespace AlienEngine.Core.Physics.Constraints
{
    ...
    public interface I1DJacobianConstraint
    {
        ...
        void GetAngularJacobianA(out Vector3f jacobian);

        /// <summary>
        /// Gets the angular jacobian entry for the second connected entity.
        /// </summary>
        /// <param name="jacobian">Angular jacobian entry for the second connected entity.</param>
        void GetAngularJacobianB(out Vector3f jacobian);

        /// <summary>
        /// Gets the linear jacobian entry for the first connected entity.
        /// </summary>
        /// <param name="jacobian">Linear jacobian entry for the first connected entity.</param>
        void GetLinearJacobianA(out Vector3f jacobian);

        /// <summary>
        /// Gets the linear jacobian entry for the second connected entity.
        /// </summary>
        /// <param name="jacobian">Linear jacobian entry for the second connected entity.</param>
        void GetLinearJacobianB(out Vector3f jacobian);
    ...
    public interface I2DJacobianConstraint
    {
        ...
        void GetAngularJacobianA(out Vector3f jacobianX, out Vector3f jacobianY);
        ...
        void GetAngularJacobianB(out Vector3f jacobianX, out Vector3f jacobianY);
        ...
        void GetLinearJacobianA(out Vector3f jacobianX, out Vector3f jacobianY);
        ...
        void GetLinearJacobianB(out Vector3f jacobianX, out Vector3f jacobianY);

        /// <summary>
        /// Gets the mass matrix of the constraint.
        /// </summary>
        /// <param name="massMatrix">Constraint's mass matrix.</param>
        void GetMassMatrix(out Matrix2f massMatrix);
    }
    ...
    public interface I3DJacobianConstraint
    {
        ...
        void GetAngularJacobianA(out Vector3f jacobianX, out Vector3f jacobianY, out Vector3f jacobianZ);
        ...
        void GetAngularJacobianB(out Vector3f jacobianX, out Vector3f jacobianY, out Vector3f jacobianZ);
        ...
        void GetLinearJacobianA(out Vector3f jacobianX, out Vector3f jacobianY, out Vector3f jacobianZ);
        ...
        void GetLinearJacobianB(out Vector3f jacobianX, out Vector3f jacobianY, out Vector3f jacobianZ);

        /// <summary>
        /// Gets the mass matrix of the constraint.
        /// </summary>
        /// <param name="outputMassMatrix">Constraint's mass matrix.</param>
        void GetMassMatrix(out Matrix3f outputMassMatrix);
    }
}
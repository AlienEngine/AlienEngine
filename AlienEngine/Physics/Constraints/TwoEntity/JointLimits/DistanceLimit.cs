...
namespace AlienEngine.Core.Physics.Constraints.TwoEntity.JointLimits
{
    ...
    public class DistanceLimit : JointLimit, I1DImpulseConstraintWithError, I1DJacobianConstraint
    {
        ...
        private Vector3f anchorA;

        private Vector3f anchorB;
        ...
        private Vector3f offsetA, offsetB;
        ...
        public DistanceLimit(Entity connectionA, Entity connectionB, Vector3f anchorA, Vector3f anchorB, float minimumLength, float maximumLength)
        {
        ...
        public Vector3f LocalAnchorA
        {
            ...
            {
                localAnchorA = value;
                Vector3f.Transform(ref localAnchorA, ref connectionA.orientationMatrix, out anchorA);
        ...
        public Vector3f LocalAnchorB
        {
            ...
            {
                localAnchorB = value;
                Vector3f.Transform(ref localAnchorB, ref connectionB.orientationMatrix, out anchorB);
        ...
        /// </summary>
        public Vector3f WorldAnchorA
        {
            get { return anchorA; }
            set
            {
                anchorA = value;
                localAnchorA = Vector3f.Transform(anchorA - connectionA.position, Quaternion.Conjugate(connectionA.orientation));
            }
        }
        ...
        /// </summary>
        public Vector3f WorldAnchorB
        {
            get { return anchorB; }
            set
            {
                anchorB = value;
                localAnchorB = Vector3f.Transform(anchorB - connectionB.position, Quaternion.Conjugate(connectionB.orientation));
            }
        }
        ...
        public override void Update(float dt)
        {
            ...
            Vector3f.Transform(ref localAnchorA, ref connectionA.orientationMatrix, out offsetA);
            Vector3f.Transform(ref localAnchorB, ref connectionB.orientationMatrix, out offsetB);
            ...
            if (distance > maximumLength)
            {
                ...
                Vector3f.Cross(ref jLinearA, ref offsetA, out jAngularA);
                //Still need to negate angular A.  It's done after the effective mass matrix.
                Vector3f.Cross(ref jLinearA, ref offsetB, out jAngularB);
            }
            else
            {
                if (distance > MathHelper.Epsilon)
                ...
                Vector3f.Cross(ref offsetA, ref jLinearB, out jAngularA);
                //Still need to negate angular A.  It's done after the effective mass matrix.
                Vector3f.Cross(ref offsetB, ref jLinearB, out jAngularB);
            }
            ...
            {
                Vector3f aAngular;
                Vector3f.Transform(ref jAngularA, ref connectionA.localInertiaTensorInverse, out aAngular);
                Vector3f.Cross(ref aAngular, ref offsetA, out aAngular);
                Vector3f bAngular;
                Vector3f.Transform(ref jAngularB, ref connectionB.localInertiaTensorInverse, out bAngular);
                Vector3f.Cross(ref bAngular, ref offsetB, out bAngular);
                Vector3f.Add(ref aAngular, ref bAngular, out aAngular);
                Vector3f.Dot(ref aAngular, ref jLinearB, out velocityToImpulse);
            ...
            else if (connectionB.isDynamic)
            {
                ...
                Vector3f.Transform(ref jAngularB, ref connectionB.localInertiaTensorInverse, out bAngular);
                Vector3f.Cross(ref bAngular, ref offsetB, out bAngular);
                Vector3f.Dot(ref bAngular, ref jLinearB, out velocityToImpulse);

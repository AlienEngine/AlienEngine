    ...
    public class NoRotationJoint : Joint, I3DImpulseConstraintWithError, I3DJacobianConstraint
    {
        ...
        public Vector3f RelativeVelocity
        {
            get
            {
                ...
                Vector3f.Subtract(ref connectionB.angularVelocity, ref connectionA.angularVelocity, out velocityDifference);
        ...
        public override float SolveIteration()
        {
            Vector3f velocityDifference;
            Vector3f.Subtract(ref connectionB.angularVelocity, ref connectionA.angularVelocity, out velocityDifference);
            Vector3f softnessVector;
            Vector3f.Multiply(ref accumulatedImpulse, softness, out softnessVector);

            Vector3f lambda;
            Vector3f.Add(ref velocityDifference, ref biasVelocity, out lambda);
            Vector3f.Subtract(ref lambda, ref softnessVector, out lambda);
            Vector3f.Transform(ref lambda, ref effectiveMassMatrix, out lambda);

            Vector3f.Add(ref lambda, ref accumulatedImpulse, out accumulatedImpulse);
            ...
            {
                Vector3f torqueB;
                Vector3f.Negate(ref lambda, out torqueB);
        ...
        public override void Update(float dt)
        {
            ...
            float angle;
            Vector3f axis;
            Quaternion.ToAxisAngle(ref intermediate, out axis, out angle);
            ...
            Matrix3f.Add(ref connectionA.inertiaTensorInverse, ref connectionB.inertiaTensorInverse, out effectiveMassMatrix);
        ...
        public override void ExclusiveUpdate()
        {
            ...
            {
                Vector3f torqueB;
                Vector3f.Negate(ref accumulatedImpulse, out torqueB);
                connectionB.ApplyAngularImpulse(ref torqueB);
            }
        } 
    }

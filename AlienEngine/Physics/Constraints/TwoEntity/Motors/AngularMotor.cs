...
namespace AlienEngine.Core.Physics.Constraints.TwoEntity.Motors
{
    ...
    public class AngularMotor : Motor, I3DImpulseConstraintWithError, I3DJacobianConstraint
    {
        ...
        public override float SolveIteration()
        {
            ...
            Vector3f lambda;
#endif
            Vector3f aVel = connectionA.angularVelocity;
            Vector3f bVel = connectionB.angularVelocity;
        ...
        public override void Update(float dt)
        {
            ...
            if (settings.mode == MotorMode.Servomechanism) //Only need to do the bulk of this work if it's a servo.
            {
                ...
                Quaternion worldBasis = Quaternion.FromRotationMatrix(basis.WorldTransform);
                ...
                Quaternion.ToAxisAngle(ref error, out axis, out angle);

                //Scale the axis by the desired velocity if the angle is sufficiently large (epsilon).
                if (angle > MathHelper.BigEpsilon)
                {
            ...
            else
            {
                ...
                Matrix3f transform = basis.WorldTransform;
                Vector3f.Transform(ref settings.velocityMotor.goalVelocity, ref transform, out biasVelocity);
            }

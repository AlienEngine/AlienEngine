...
namespace AlienEngine.Core.Physics.Constraints.TwoEntity.Motors
{
    ...
    public class LinearAxisMotor : Motor, I1DImpulseConstraintWithError, I1DJacobianConstraint
    {
        ...
        public LinearAxisMotor(Entity connectionA, Entity connectionB, Vector3f anchorA, Vector3f anchorB, Vector3f axis)
        {
        ...
        public Vector3f OffsetA
        {
            ...
            set
            {
                worldOffsetA = value;
                worldAnchorA = connectionA.position + worldOffsetA;
                Vector3f.TransformTranspose(ref worldOffsetA, ref connectionA.orientationMatrix, out localAnchorA); //Looks weird, but localAnchorA is "localOffsetA."
        ...
        public Vector3f OffsetB
        {
            ...
            set
            {
                worldOffsetB = value;
                worldAnchorB = connectionB.position + worldOffsetB;
                Vector3f.TransformTranspose(ref worldOffsetB, ref connectionB.orientationMatrix, out localAnchorB);//Looks weird, but localAnchorB is "localOffsetB."
            }
        }
        ...
        public override void Update(float dt)
        {
            ...
            Vector3f separation = new Vector3f();
                ...
                Vector3f.Dot(ref separation, ref worldAxis, out error);

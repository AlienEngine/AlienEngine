...
namespace AlienEngine.Core.Physics.Constraints.SingleEntity
{
    ...
    public class SingleEntityAngularMotor : SingleEntityConstraint, I3DImpulseConstraintWithError
    {
        ...
        public override float SolveIteration()
        {
            ...
            Vector3f lambda;
#endif
            Vector3f aVel = entity.angularVelocity;
        ...
        public override void Update(float dt)
        {
            ...
            if (settings.mode == MotorMode.Servomechanism) //Only need to do the bulk of this work if it's a servo.
            {
                ...
                Quaternion.FromRotationMatrix(ref worldTransform, out currentRelativeOrientation);
                ...
                Quaternion.ToAxisAngle(ref errorOrientation, out axis, out angle);

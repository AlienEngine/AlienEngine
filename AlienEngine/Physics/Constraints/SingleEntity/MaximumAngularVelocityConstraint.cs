...
namespace AlienEngine.Core.Physics.Constraints.SingleEntity
{
    ...
    public class MaximumAngularSpeedConstraint : SingleEntityConstraint, I3DImpulseConstraint
    {
        ...
        /// </summary>
        Vector3f I3DImpulseConstraint.RelativeVelocity
        {
        ...
        public override float SolveIteration()
        {
            ...
            if (angularSpeed > maximumSpeedSquared)
            {
                ...
                Vector3f.Multiply(ref entity.angularVelocity, -(angularSpeed - maximumSpeed) / angularSpeed, out impulse);
                ...
                Vector3f.Transform(ref impulse, ref effectiveMassMatrix, out impulse);

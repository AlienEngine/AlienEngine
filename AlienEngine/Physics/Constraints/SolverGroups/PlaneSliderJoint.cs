...
namespace AlienEngine.Core.Physics.Constraints.SolverGroups
{
    ...
    public class PlaneSliderJoint : SolverGroup
    {
        ...
        public PlaneSliderJoint(Entity connectionA, Entity connectionB, Vector3f planeAnchor, Vector3f planeNormal, Vector3f xAxis, Vector3f yAxis, Vector3f pointAnchor)
        {
            if (connectionA == null)

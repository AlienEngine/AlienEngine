...
namespace AlienEngine.Core.Physics.Constraints.Collision
{
    ...
    public class ContactFrictionConstraint : SolverUpdateable
    {
        ...
        /// </summary>
        public Vector3f FrictionDirection
        {
            get { return new Vector3f(linearAX, linearAY, linearAZ); }
        }
        ...
        public override void Update(float dt)
        {
            ...
            Vector3f velocityA = new Vector3f(), velocityB = new Vector3f();
            Vector3f ra = penetrationConstraint.ra, rb = penetrationConstraint.rb;
            if (entityA != null)
            {
            ...
            Vector3f normal = penetrationConstraint.contact.Normal;

...
namespace AlienEngine.Core.Physics.Constraints.Collision
{
    /// <summary>
    ...
    public class SlidingFrictionTwoAxis : SolverUpdateable
    {
        ...
        internal Vector2f accumulatedImpulse;
        internal Matrix2x3f angularA, angularB;
        private int contactCount;
        private float friction;
        internal Matrix2x3f linearA;
        private Entity entityA, entityB;
        private bool entityADynamic, entityBDynamic;
        private Vector3f ra, rb;
        private Matrix2f velocityToImpulse;
        ...
        /// </summary>
        public Vector3f FrictionDirectionX
        {
            get { return new Vector3f(linearA.M11, linearA.M12, linearA.M13); }
        }
        ...
        /// This is one of two directions that are perpendicular to each other and the normal of a collision between two entities.
        /// </summary>
        public Vector3f FrictionDirectionY
        {
            get { return new Vector3f(linearA.M21, linearA.M22, linearA.M23); }
        }
        ...
        public Vector2f RelativeVelocity
        {
            get
            {
                ...
                //Vector3f wara, wbrb;
                //Vector3f.Cross(ref parentA.myInternalAngularVelocity, ref Ra, out wara);
                //Vector3f.Cross(ref parentB.myInternalAngularVelocity, ref Rb, out wbrb);
        ...
        public override float SolveIteration()
        {
            ...
            Vector2f lambda = RelativeVelocity;

            //Convert to impulse
            //Matrix2f.Transform(ref lambda, ref velocityToImpulse, out lambda);
            float x = lambda.X;
        ...
        internal Vector3f manifoldCenter, relativeVelocity;
        ...
        {
            accumulatedImpulse = new Vector2f();

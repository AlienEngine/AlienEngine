...
namespace AlienEngine.Core.Physics.Character
{
    ...
    public class VerticalMotionConstraint : SolverUpdateable
    {
        ...
        Vector3f linearJacobianA;
        Vector3f linearJacobianB;
        Vector3f angularJacobianB;
        ...
        public override void ExclusiveUpdate()
        {
            ...
            Vector3f torque;
#endif
            Vector3f.Multiply(ref linearJacobianA, accumulatedImpulse, out impulse);
            ...
            if (supportEntity != null && supportEntity.IsDynamic)
            {
                ...
                Vector3f.Multiply(ref angularJacobianB, accumulatedImpulse * supportForceFactor, out torque);
        ...
        public override float SolveIteration()
        {
            ...
            Vector3f torque;
#endif
            Vector3f.Multiply(ref linearJacobianA, lambda, out impulse);
            ...
            if (supportEntity != null && supportEntity.IsDynamic)
            {
                ...
                Vector3f.Multiply(ref angularJacobianB, lambda * supportForceFactor, out torque);
        ...
        public float RelativeVelocity
        {
            get
            {
                ...
                Vector3f.Dot(ref linearJacobianA, ref characterBody.linearVelocity, out relativeVelocity);

                if (supportEntity != null)
                {
                    float supportVelocity;
                    Vector3f.Dot(ref linearJacobianB, ref supportEntity.linearVelocity, out supportVelocity);
                    relativeVelocity += supportVelocity;
                    Vector3f.Dot(ref angularJacobianB, ref supportEntity.angularVelocity, out supportVelocity);
                    relativeVelocity += supportVelocity;

...
namespace AlienEngine.Core.Physics.Character
{
    ...
    public class StanceManager
    {
        ...
        private void PrepareQueryObject(EntityCollidable queryObject, ref Vector3f position)
        {
        ...
        public bool CheckTransition(Stance targetStance, out float newHeight, out Vector3f newPosition)
        {
            ...
            if (CurrentStance != targetStance)
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        {
                            Vector3f candidatePosition = currentPosition + currentOffset * down;
                            float hintOffset;
        ...
        public bool UpdateStance(out Vector3f newPosition)
        {
            float newHeight;
        ...
        CharacterContactPositionState TrySupportLocation(ConvexCollidable<CylinderShape> queryObject, ref Vector3f position, out float hintOffset,

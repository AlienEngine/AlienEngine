...
namespace AlienEngine.Core.Physics.NarrowPhaseSystems.Pairs
{
    ...
    public abstract class MobileMeshPairHandler : StandardPairHandler
    {
        ...
        public override void UpdateTimeOfImpact(Collidable requester, float dt)
        {
                ...
                )
            {
                ...
                {                    
                    ...
                    Vector3f.Negate(ref mobileMesh.entity.linearVelocity, out velocity);
                }
                ...
                else
                {
                    ...
                    Vector3f.Subtract(ref convex.entity.linearVelocity, ref mobileMesh.entity.linearVelocity, out velocity);

                }
                Vector3f.Multiply(ref velocity, dt, out velocity);
                ...
                if (minimumRadius * minimumRadius < velocitySquared)
                {
                    ...
                    Matrix3f.FromQuaternion(ref mobileMesh.worldTransform.Orientation, out orientation);
                    ...
                    for (int i = 0; i < MeshManifold.overlappedTriangles.Count; i++)
                    {
                        ...
                        Vector3f.Transform(ref triangle.vA, ref orientation, out triangle.vA);
                        Vector3f.Transform(ref triangle.vB, ref orientation, out triangle.vB);
                        Vector3f.Transform(ref triangle.vC, ref orientation, out triangle.vC);
                        Vector3f.Add(ref triangle.vA, ref mobileMesh.worldTransform.Position, out triangle.vA);
                        Vector3f.Add(ref triangle.vB, ref mobileMesh.worldTransform.Position, out triangle.vB);
                        Vector3f.Add(ref triangle.vC, ref mobileMesh.worldTransform.Position, out triangle.vC);
        ...
        protected internal override void GetContactInformation(int index, out ContactInformation info)
        {
            ...
            {
                Vector3f.Subtract(ref info.Contact.Position, ref convex.entity.position, out velocity);
                Vector3f.Cross(ref convex.entity.angularVelocity, ref velocity, out velocity);
                Vector3f.Add(ref velocity, ref convex.entity.linearVelocity, out info.RelativeVelocity);
            }
            else
            ...
            {
                Vector3f.Subtract(ref info.Contact.Position, ref mobileMesh.entity.position, out velocity);
                Vector3f.Cross(ref mobileMesh.entity.angularVelocity, ref velocity, out velocity);
                Vector3f.Add(ref velocity, ref mobileMesh.entity.linearVelocity, out velocity);

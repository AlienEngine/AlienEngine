...
namespace AlienEngine.Core.Physics.NarrowPhaseSystems.Pairs
{
    ...
    public class MobileMeshInstancedMeshPairHandler : MobileMeshMeshPairHandler
    {
        ...
        protected override TriangleCollidable GetOpposingCollidable(int index)
        {
            ...
            Vector3f.Transform(ref shape.vA, ref mesh.worldTransform.LinearTransform, out shape.vA);
            Vector3f.Transform(ref shape.vB, ref mesh.worldTransform.LinearTransform, out shape.vB);
            Vector3f.Transform(ref shape.vC, ref mesh.worldTransform.LinearTransform, out shape.vC);
            Vector3f center;
            ...
            Vector3f.Add(ref center, ref mesh.worldTransform.Translation, out center);
        ...
        protected override void UpdateContainedPairs(float dt)
        {
            ...
            Vector3f sweep;
            Vector3f.Multiply(ref mobileMesh.entity.linearVelocity, dt, out sweep);

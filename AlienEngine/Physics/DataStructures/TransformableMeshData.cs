namespace AlienEngine.Core.Physics.DataStructures
{
    ...
    public class TransformableMeshData : MeshBoundingBoxTreeData
    {
        ...
        public TransformableMeshData(Vector3f[] vertices, int[] indices)
        {
            Vertices = vertices;
            Indices = indices;
        }
        ...
        public TransformableMeshData(Vector3f[] vertices, int[] indices, AffineTransform worldTransform)
        {
        ...
        public override void GetTriangle(int triangleIndex, out Vector3f v1, out Vector3f v2, out Vector3f v3)
        {
        ...
        public override void GetVertexPosition(int i, out Vector3f vertex)
        {

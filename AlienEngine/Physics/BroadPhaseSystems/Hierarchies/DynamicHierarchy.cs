...
namespace AlienEngine.Core.Physics.BroadPhaseSystems.Hierarchies
{
    /// <summary>
    ...
    public class DynamicHierarchy : BroadPhase
    {
        ...
        public override void Add(BroadPhaseEntry entry)
        {
            ...
            Vector3f offset;
            Vector3f.Subtract(ref entry.boundingBox.Max, ref entry.boundingBox.Min, out offset);
            ...
            else
            {
                ...
                else
                {
                    ...
                    Vector3f.Subtract(ref root.BoundingBox.Max, ref root.BoundingBox.Min, out offset);

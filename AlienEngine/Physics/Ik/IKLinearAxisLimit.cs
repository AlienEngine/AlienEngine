namespace AlienEngine.Core.Physics.Ik
{
    ...
    public class IKLinearAxisLimit : IKLimit
    {
        ...
        public IKLinearAxisLimit(Bone connectionA, Bone connectionB, Vector3f lineAnchor, Vector3f lineDirection, Vector3f anchorB, float minimumDistance, float maximumDistance)
        ...
        protected internal override void UpdateJacobiansAndVelocityBias()
        {
            ...
            Vector3f.Transform(ref LocalLineAnchor, ref ConnectionA.Orientation, out offsetA);
            ...
            else if (currentDistance < minimumDistance)
            {
                ...
                Vector3f.Negate(ref lineDirection, out lineDirection);
            }

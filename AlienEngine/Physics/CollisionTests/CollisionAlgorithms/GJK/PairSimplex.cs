...
namespace AlienEngine.Core.Physics.CollisionTests.CollisionAlgorithms.GJK
{
    ...
    public struct CachedSimplex
    {
        ...
        //    Vector3f direction;
        //    Vector3f.Negate(ref localTransformB.Position, out direction);
    ...
    public struct PairSimplex
    {
        ...
        private PairSimplex(ref RigidTransform localTransformB)
        {
            ...
            Vector3f.Negate(ref localTransformB.Position, out A);
            B = new Vector3f();
            C = new Vector3f();
            D = new Vector3f();
            U = 0;
        ...
        public PairSimplex(ref CachedSimplex cachedSimplex, ref RigidTransform localTransformB)
        {
            ...
            switch (State)
            {
                case SimplexState.Point:
                    Vector3f.Transform(ref cachedSimplex.LocalSimplexB.A, ref LocalTransformB.Orientation, out SimplexB.A);
                    Vector3f.Add(ref SimplexB.A, ref LocalTransformB.Position, out SimplexB.A);

                    Vector3f.Subtract(ref SimplexA.A, ref SimplexB.A, out A);
                    B = new Vector3f();
                    C = new Vector3f();
                    D = new Vector3f();
                    break;
                case SimplexState.Segment:
                    Matrix3f transform;
                    Matrix3f.FromQuaternion(ref localTransformB.Orientation, out transform);
                    Vector3f.Transform(ref cachedSimplex.LocalSimplexB.A, ref transform, out SimplexB.A);
                    Vector3f.Transform(ref cachedSimplex.LocalSimplexB.B, ref transform, out SimplexB.B);
                    Vector3f.Add(ref SimplexB.A, ref LocalTransformB.Position, out SimplexB.A);
                    Vector3f.Add(ref SimplexB.B, ref LocalTransformB.Position, out SimplexB.B);

                    Vector3f.Subtract(ref SimplexA.A, ref SimplexB.A, out A);
                    Vector3f.Subtract(ref SimplexA.B, ref SimplexB.B, out B);
                    C = new Vector3f();
                    D = new Vector3f();

                    ////Test for degeneracy.
                    //float edgeLengthAB;
                    //Vector3f.DistanceSquared(ref A, ref B, out edgeLengthAB);
                ...
                case SimplexState.Triangle:
                    ...
                    Vector3f.Transform(ref cachedSimplex.LocalSimplexB.A, ref transform, out SimplexB.A);
                    Vector3f.Transform(ref cachedSimplex.LocalSimplexB.B, ref transform, out SimplexB.B);
                    Vector3f.Transform(ref cachedSimplex.LocalSimplexB.C, ref transform, out SimplexB.C);
                    Vector3f.Add(ref SimplexB.A, ref LocalTransformB.Position, out SimplexB.A);
                    Vector3f.Add(ref SimplexB.B, ref LocalTransformB.Position, out SimplexB.B);
                    Vector3f.Add(ref SimplexB.C, ref LocalTransformB.Position, out SimplexB.C);

                    Vector3f.Subtract(ref SimplexA.A, ref SimplexB.A, out A);
                    Vector3f.Subtract(ref SimplexA.B, ref SimplexB.B, out B);
                    Vector3f.Subtract(ref SimplexA.C, ref SimplexB.C, out C);
                    D = new Vector3f();
                    ...
                    //Vector3f cross;
                    //Vector3f.Cross(ref AB, ref AC, out cross);
                ...
                case SimplexState.Tetrahedron:
                    ...
                    Vector3f.Transform(ref cachedSimplex.LocalSimplexB.B, ref transform, out SimplexB.B);
                    Vector3f.Transform(ref cachedSimplex.LocalSimplexB.C, ref transform, out SimplexB.C);
                    Vector3f.Transform(ref cachedSimplex.LocalSimplexB.D, ref transform, out SimplexB.D);
                    Vector3f.Add(ref SimplexB.A, ref LocalTransformB.Position, out SimplexB.A);
                    Vector3f.Add(ref SimplexB.B, ref LocalTransformB.Position, out SimplexB.B);
                    Vector3f.Add(ref SimplexB.C, ref LocalTransformB.Position, out SimplexB.C);
                    Vector3f.Add(ref SimplexB.D, ref LocalTransformB.Position, out SimplexB.D);

                    Vector3f.Subtract(ref SimplexA.A, ref SimplexB.A, out A);
                    Vector3f.Subtract(ref SimplexA.B, ref SimplexB.B, out B);
                    Vector3f.Subtract(ref SimplexA.C, ref SimplexB.C, out C);
                    Vector3f.Subtract(ref SimplexA.D, ref SimplexB.D, out D);

                    ////Test for degeneracy.
                    //Vector3f AD;
                    //Vector3f.Subtract(ref B, ref A, out AB);
                    //Vector3f.Subtract(ref C, ref A, out AC);
                    //Vector3f.Subtract(ref D, ref A, out AD);
                    //Vector3f.Cross(ref AB, ref AC, out cross);
                    //float volume;
                    //Vector3f.Dot(ref cross, ref AD, out volume);
        ...
        public void UpdateCachedSimplex(ref CachedSimplex simplex)
        {
            ...
            {
                case SimplexState.Point:
                    Vector3f.Subtract(ref SimplexB.A, ref LocalTransformB.Position, out simplex.LocalSimplexB.A);
                    Quaternion conjugate;
                    Quaternion.Conjugate(ref LocalTransformB.Orientation, out conjugate);
                    Vector3f.Transform(ref simplex.LocalSimplexB.A, ref conjugate, out simplex.LocalSimplexB.A);
                    break;
                case SimplexState.Segment:
                    Vector3f.Subtract(ref SimplexB.A, ref LocalTransformB.Position, out simplex.LocalSimplexB.A);
                    Vector3f.Subtract(ref SimplexB.B, ref LocalTransformB.Position, out simplex.LocalSimplexB.B);

                    Matrix3f transform;
                    Matrix3f.FromQuaternion(ref LocalTransformB.Orientation, out transform);
                    Vector3f.TransformTranspose(ref simplex.LocalSimplexB.A, ref transform, out simplex.LocalSimplexB.A);
                    Vector3f.TransformTranspose(ref simplex.LocalSimplexB.B, ref transform, out simplex.LocalSimplexB.B);
                    break;
                case SimplexState.Triangle:
                    Vector3f.Subtract(ref SimplexB.A, ref LocalTransformB.Position, out simplex.LocalSimplexB.A);
                    Vector3f.Subtract(ref SimplexB.B, ref LocalTransformB.Position, out simplex.LocalSimplexB.B);
                    Vector3f.Subtract(ref SimplexB.C, ref LocalTransformB.Position, out simplex.LocalSimplexB.C);

                    Matrix3f.FromQuaternion(ref LocalTransformB.Orientation, out transform);
                    Vector3f.TransformTranspose(ref simplex.LocalSimplexB.A, ref transform, out simplex.LocalSimplexB.A);
                    Vector3f.TransformTranspose(ref simplex.LocalSimplexB.B, ref transform, out simplex.LocalSimplexB.B);
                    Vector3f.TransformTranspose(ref simplex.LocalSimplexB.C, ref transform, out simplex.LocalSimplexB.C);
                    break;
                case SimplexState.Tetrahedron:
                    Vector3f.Subtract(ref SimplexB.A, ref LocalTransformB.Position, out simplex.LocalSimplexB.A);
                    Vector3f.Subtract(ref SimplexB.B, ref LocalTransformB.Position, out simplex.LocalSimplexB.B);
                    Vector3f.Subtract(ref SimplexB.C, ref LocalTransformB.Position, out simplex.LocalSimplexB.C);
                    Vector3f.Subtract(ref SimplexB.D, ref LocalTransformB.Position, out simplex.LocalSimplexB.D);

                    Matrix3f.FromQuaternion(ref LocalTransformB.Orientation, out transform);
                    Vector3f.TransformTranspose(ref simplex.LocalSimplexB.A, ref transform, out simplex.LocalSimplexB.A);
                    Vector3f.TransformTranspose(ref simplex.LocalSimplexB.B, ref transform, out simplex.LocalSimplexB.B);
                    Vector3f.TransformTranspose(ref simplex.LocalSimplexB.C, ref transform, out simplex.LocalSimplexB.C);
                    Vector3f.TransformTranspose(ref simplex.LocalSimplexB.D, ref transform, out simplex.LocalSimplexB.D);
                    break;
            }
            simplex.State = State;
        }
        ...
        public bool GetPointClosestToOrigin(out Vector3f point)
        {
        ...
        ///</summary>
        ///<param name="point">Point closest to origin.</param>
        public void GetPointOnTriangleClosestToOrigin(out Vector3f point)
        {
            Vector3f ab, ac;
            Vector3f.Subtract(ref B, ref A, out ab);
            Vector3f.Subtract(ref C, ref A, out ac);
            ...
            float AdotAB, AdotAC;
            Vector3f.Dot(ref ab, ref A, out AdotAB);
            Vector3f.Dot(ref ac, ref A, out AdotAC);
            AdotAB = -AdotAB;
            AdotAC = -AdotAC;
            ...
            float BdotAB, BdotAC;
            Vector3f.Dot(ref ab, ref B, out BdotAB);
            Vector3f.Dot(ref ac, ref B, out BdotAC);
            BdotAB = -BdotAB;
            BdotAC = -BdotAC;
            ...
            if (vc <= 0 && AdotAB > 0 && BdotAB < 0)//Note > and < instead of => <=; avoids possibly division by zero
            {
                ...
                Vector3f.Multiply(ref ab, V, out point);
                Vector3f.Add(ref point, ref A, out point);
                return;
            }
            ...
            float CdotAB, CdotAC;
            Vector3f.Dot(ref ab, ref C, out CdotAB);
            Vector3f.Dot(ref ac, ref C, out CdotAC);
            CdotAB = -CdotAB;
            CdotAC = -CdotAC;
            ...
            if (vb <= 0f && AdotAC > 0f && CdotAC < 0f)//Note > instead of >= and < instead of <=; prevents bad denominator
            {
                ...
                U = 1 - V;
                Vector3f.Multiply(ref ac, V, out point);
                Vector3f.Add(ref point, ref A, out point);
                return;
            }
            ...
            if (va <= 0f && (d3d4 = BdotAC - BdotAB) > 0f && (d6d5 = CdotAB - CdotAC) > 0f)//Note > instead of >= and < instead of <=; prevents bad denominator
            {
                ...
                Vector3f bc;
                Vector3f.Subtract(ref C, ref B, out bc);
                Vector3f.Multiply(ref bc, U, out point);
                Vector3f.Add(ref point, ref B, out point);
                return;
            }
            ...
            Vector3f.Add(ref A, ref point, out point);
            Vector3f.Add(ref point, ref acw, out point);
        ...
        public bool GetPointOnTetrahedronClosestToOrigin(out Vector3f point)
        {
        ...
        private static bool TryTetrahedronTriangle(ref Vector3f A, ref Vector3f B, ref Vector3f C,
                                                   ref Vector3f A1, ref Vector3f B1, ref Vector3f C1,
                                                   ref Vector3f A2, ref Vector3f B2, ref Vector3f C2,
                                                   float errorTolerance,
                                                   ref Vector3f otherPoint, out PairSimplex simplex, out Vector3f point)
        {
            ...
            float AdotN, ADdotN;
            Vector3f AD;
            Vector3f.Subtract(ref otherPoint, ref A, out AD);
            Vector3f.Dot(ref A, ref normal, out AdotN);
            Vector3f.Dot(ref AD, ref normal, out ADdotN);

            //If (-A * N) * (AD * N) < 0, D and O are on opposite sides of the triangle.
            if (AdotN * ADdotN >= -MathHelper.Epsilon * errorTolerance)
            {
                //The point we are comparing against the triangle is 0,0,0, so instead of storing an "A->P" vector,
                //just use -A.
                //Same for B->, C->P...
                ...
                if (vc <= 0 && AdotAB > 0 && BdotAB < 0) //Note > and < instead of => <=; avoids possibly division by zero
                {
                    ...
                    Vector3f.Multiply(ref ab, simplex.V, out point);
                    Vector3f.Add(ref point, ref A, out point);
                    return true;
                }
                ...
                if (vb <= 0f && AdotAC > 0f && CdotAC < 0f) //Note > instead of >= and < instead of <=; prevents bad denominator
                {
                    ...
                    simplex.U = 1 - simplex.V;
                    Vector3f.Multiply(ref ac, simplex.V, out point);
                    Vector3f.Add(ref point, ref A, out point);
                    return true;
                }
                ...
                if (va <= 0f && (d3d4 = BdotAC - BdotAB) > 0f && (d6d5 = CdotAB - CdotAC) > 0f)//Note > instead of >= and < instead of <=; prevents bad denominator
                {
                    ...
                    Vector3f bc;
                    Vector3f.Subtract(ref C, ref B, out bc);
                    Vector3f.Multiply(ref bc, simplex.V, out point);
                    Vector3f.Add(ref point, ref B, out point);
                    return true;
                }
                ...
                Vector3f.Multiply(ref ab, simplex.V, out point);
                Vector3f acw;
                Vector3f.Multiply(ref ac, simplex.W, out acw);
                Vector3f.Add(ref A, ref point, out point);
                Vector3f.Add(ref point, ref acw, out point);
                return true;
            }
        ...
        public bool GetNewSimplexPoint(ConvexShape shapeA, ConvexShape shapeB, int iterationCount, ref Vector3f closestPoint)
        {
            Vector3f negativeDirection;
            Vector3f.Negate(ref closestPoint, out negativeDirection);
            Vector3f sa, sb;
        ...
        public void GetClosestPoints(out Vector3f closestPointA, out Vector3f closestPointB)
        {
            //A * U + B * V + C * W
            switch (State)
            {
                ...
                case SimplexState.Segment:
                    Vector3f temp;
                    Vector3f.Multiply(ref SimplexA.A, U, out closestPointA);
                    Vector3f.Multiply(ref SimplexA.B, V, out temp);
                    Vector3f.Add(ref closestPointA, ref temp, out closestPointA);

                    Vector3f.Multiply(ref SimplexB.A, U, out closestPointB);
                    Vector3f.Multiply(ref SimplexB.B, V, out temp);
                    Vector3f.Add(ref closestPointB, ref temp, out closestPointB);
                    return;
                case SimplexState.Triangle:
                    Vector3f.Multiply(ref SimplexA.A, U, out closestPointA);
                    Vector3f.Multiply(ref SimplexA.B, V, out temp);
                    Vector3f.Add(ref closestPointA, ref temp, out closestPointA);
                    Vector3f.Multiply(ref SimplexA.C, W, out temp);
                    Vector3f.Add(ref closestPointA, ref temp, out closestPointA);

                    Vector3f.Multiply(ref SimplexB.A, U, out closestPointB);
                    Vector3f.Multiply(ref SimplexB.B, V, out temp);
                    Vector3f.Add(ref closestPointB, ref temp, out closestPointB);
                    Vector3f.Multiply(ref SimplexB.C, W, out temp);
                    Vector3f.Add(ref closestPointB, ref temp, out closestPointB);
                    return;
            }
        ...
        internal void VerifyContributions()
        {
            ...
            {
                case SimplexState.Point:
                    if (Vector3f.Distance(SimplexA.A - SimplexB.A, A) > .0001f)
                ...
                case SimplexState.Segment:
                    ...
                    if (Vector3f.Distance(SimplexA.B - SimplexB.B, B) > .0001f)
                        Debug.WriteLine("break.");
                    break;
                case SimplexState.Triangle:
                    if (Vector3f.Distance(SimplexA.A - SimplexB.A, A) > .0001f)
                    ...
                    if (Vector3f.Distance(SimplexA.C - SimplexB.C, C) > .0001f)
                        Debug.WriteLine("break.");
                    break;
                ...
                case SimplexState.Tetrahedron:
                    ...
                    if (Vector3f.Distance(SimplexA.D - SimplexB.D, D) > .0001f)
                        Debug.WriteLine("break.");
                    break;
            }
        }

...
namespace AlienEngine.Core.Physics.CollisionTests.CollisionAlgorithms.GJK
{
    ...
    public struct SimpleSimplex
    {
        ...
        public void GetPointOnTriangleClosestToOrigin(out Vector3f point)
        {
            ...
            float d5, d6;
            Vector3f.Dot(ref ab, ref C, out d5);
            Vector3f.Dot(ref ac, ref C, out d6);
            d5 = -d5;
            d6 = -d6;
            if (d6 >= 0f && d5 <= d6)
            {
            ...
            float d1, d2;
            Vector3f.Dot(ref ab, ref A, out d1);
            Vector3f.Dot(ref ac, ref A, out d2);
            d1 = -d1;
            d2 = -d2;
            ...
            float d3, d4;
            Vector3f.Dot(ref ab, ref B, out d3);
            Vector3f.Dot(ref ac, ref B, out d4);
            d3 = -d3;
            d4 = -d4;
        ...
        private static bool TryTetrahedronTriangle(ref Vector3f A, ref Vector3f B, ref Vector3f C, 
                                                   ref Vector3f otherPoint, out SimpleSimplex simplex, out Vector3f point)
        {
        ...
        public void AddNewSimplexPoint(ref Vector3f point)
        {
            switch (State)
            {

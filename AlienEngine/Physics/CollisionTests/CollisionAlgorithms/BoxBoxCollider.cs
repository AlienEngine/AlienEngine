...
namespace AlienEngine.Core.Physics.CollisionTests.CollisionAlgorithms
{
    ...
    public static class BoxBoxCollider
    {
        ...
        public static bool AreBoxesColliding(BoxShape a, BoxShape b, ref RigidTransform transformA, ref RigidTransform transformB)
        {
            ...
            Matrix3f aO;
            Matrix3f.FromQuaternion(ref transformA.Orientation, out aO);
            Matrix3f bO;
            Matrix3f.FromQuaternion(ref transformB.Orientation, out bO);

            //Relative translation rotated into A's configuration space.
            Vector3f t;
            Vector3f.Subtract(ref transformB.Position, ref transformA.Position, out t);
            ...
            absBR.M11 = Math.Abs(bR.M11) + MathHelper.Epsilon;
            absBR.M12 = Math.Abs(bR.M12) + MathHelper.Epsilon;
            absBR.M13 = Math.Abs(bR.M13) + MathHelper.Epsilon;
            float tX = t.X;
            ...
            absBR.M21 = Math.Abs(bR.M21) + MathHelper.Epsilon;
            absBR.M22 = Math.Abs(bR.M22) + MathHelper.Epsilon;
            absBR.M23 = Math.Abs(bR.M23) + MathHelper.Epsilon;
            float tY = t.Y;
            ...
            absBR.M31 = Math.Abs(bR.M31) + MathHelper.Epsilon;
            absBR.M32 = Math.Abs(bR.M32) + MathHelper.Epsilon;
            absBR.M33 = Math.Abs(bR.M33) + MathHelper.Epsilon;
        ...
        /// <param name="transformB">Transform to apply to shape B.</param>
        /// <returns>Whether or not the boxes collide.</returns>
        public static bool AreBoxesColliding(BoxShape a, BoxShape b, ref RigidTransform transformA, ref RigidTransform transformB, out float separationDistance, out Vector3f separatingAxis)
        {
            float aX = a.HalfWidth;
            float aY = a.HalfHeight;
            float aZ = a.HalfLength;
            ...
            if (t.X > rarb)
            {
                ...
                separatingAxis = new Vector3f(aO.M11, aO.M12, aO.M13);
                return false;
            }
            if (t.X < -rarb)
            {
            ...
            if (t.Y > rarb)
            {
                ...
                separatingAxis = new Vector3f(aO.M21, aO.M22, aO.M23);
                return false;
            }
            if (t.Y < -rarb)
            {
            ...
            if (t.Z > rarb)
            {
                ...
                separatingAxis = new Vector3f(aO.M31, aO.M32, aO.M33);
                return false;
            }
            if (t.Z < -rarb)
            {
            ...
            if (tl > rarb)
            {
                ...
                separatingAxis = new Vector3f(bO.M11, bO.M12, bO.M13);
                return false;
            }
            if (tl < -rarb)
            {
            ...
            {
                separationDistance = tl - rarb;
                separatingAxis = new Vector3f(bO.M21, bO.M22, bO.M23);
                return false;
            }
            if (tl < -rarb)
            {
            ...
            {
                separationDistance = tl - rarb;
                separatingAxis = new Vector3f(bO.M31, bO.M32, bO.M33);
                return false;
            }
            if (tl < -rarb)
            {
            ...
            {
                separationDistance = tl - rarb;
                separatingAxis = new Vector3f(aO.M12 * bO.M13 - aO.M13 * bO.M12,
            ...
            {
                separationDistance = -tl - rarb;
                separatingAxis = new Vector3f(bO.M12 * aO.M13 - bO.M13 * aO.M12,
            ...
            {
                separationDistance = tl - rarb;
                separatingAxis = new Vector3f(aO.M12 * bO.M23 - aO.M13 * bO.M22,
            ...
            {
                separationDistance = -tl - rarb;
                separatingAxis = new Vector3f(bO.M22 * aO.M13 - bO.M23 * aO.M12,
            ...
            {
                separationDistance = tl - rarb;
                separatingAxis = new Vector3f(aO.M12 * bO.M33 - aO.M13 * bO.M32,
            ...
            {
                separationDistance = -tl - rarb;
                separatingAxis = new Vector3f(bO.M32 * aO.M13 - bO.M33 * aO.M12,
            ...
            {
                separationDistance = tl - rarb;
                separatingAxis = new Vector3f(aO.M22 * bO.M13 - aO.M23 * bO.M12,
            ...
            {
                separationDistance = -tl - rarb;
                separatingAxis = new Vector3f(bO.M12 * aO.M23 - bO.M13 * aO.M22,
            ...
            {
                separationDistance = tl - rarb;
                separatingAxis = new Vector3f(aO.M22 * bO.M23 - aO.M23 * bO.M22,
            ...
            {
                separationDistance = -tl - rarb;
                separatingAxis = new Vector3f(bO.M22 * aO.M23 - bO.M23 * aO.M22,
            ...
            {
                separationDistance = tl - rarb;
                separatingAxis = new Vector3f(aO.M22 * bO.M33 - aO.M23 * bO.M32,
            ...
            {
                separationDistance = -tl - rarb;
                separatingAxis = new Vector3f(bO.M32 * aO.M23 - bO.M33 * aO.M22,
            ...
            {
                separationDistance = tl - rarb;
                separatingAxis = new Vector3f(aO.M32 * bO.M13 - aO.M33 * bO.M12,
            ...
            {
                separationDistance = -tl - rarb;
                separatingAxis = new Vector3f(bO.M12 * aO.M33 - bO.M13 * aO.M32,
            ...
            {
                separationDistance = tl - rarb;
                separatingAxis = new Vector3f(aO.M32 * bO.M23 - aO.M33 * bO.M22,
            ...
            {
                separationDistance = -tl - rarb;
                separatingAxis = new Vector3f(bO.M22 * aO.M33 - bO.M23 * aO.M32,
            ...
            {
                separationDistance = tl - rarb;
                separatingAxis = new Vector3f(aO.M32 * bO.M33 - aO.M33 * bO.M32,
            ...
            {
                separationDistance = -tl - rarb;
                separatingAxis = new Vector3f(bO.M32 * aO.M33 - bO.M33 * aO.M32,
        ...
        /// <param name="transformB">Transform to apply to shape B.</param>
        /// <returns>Whether or not the boxes collide.</returns>
        public static bool AreBoxesCollidingWithPenetration(BoxShape a, BoxShape b, ref RigidTransform transformA, ref RigidTransform transformB, out float distance, out Vector3f axis)
        {
            float aX = a.HalfWidth;
            float aY = a.HalfHeight;
            float aZ = a.HalfLength;
            ...
            {
                distance = t.X - rarb;
                axis = new Vector3f(aO.M11, aO.M12, aO.M13);
                return false;
            }
            if (t.X < -rarb)
            {
            ...
            if (t.X > 0)
            {
                ...
                if (tempDistance > minimumDistance)
                {
                    ...
                    minimumAxis = new Vector3f(aO.M11, aO.M12, aO.M13);
                }
            }
            else
            {
            ...
            {
                distance = t.Y - rarb;
                axis = new Vector3f(aO.M21, aO.M22, aO.M23);
                return false;
            }
            if (t.Y < -rarb)
            {
            ...
            if (t.Y > 0)
            {
                ...
                {
                    minimumDistance = tempDistance;
                    minimumAxis = new Vector3f(aO.M21, aO.M22, aO.M23);
                }
            }
            else
            {
            ...
            {
                distance = t.Z - rarb;
                axis = new Vector3f(aO.M31, aO.M32, aO.M33);
                return false;
            }
            if (t.Z < -rarb)
            {
            ...
            if (t.Z > 0)
            {
                ...
                {
                    minimumDistance = tempDistance;
                    minimumAxis = new Vector3f(aO.M31, aO.M32, aO.M33);
                }
            }
            else
            {
            ...
            {
                distance = tl - rarb;
                axis = new Vector3f(bO.M11, bO.M12, bO.M13);
                return false;
            }
            if (tl < -rarb)
            {
            ...
            if (tl > 0)
            {
                ...
                {
                    minimumDistance = tempDistance;
                    minimumAxis = new Vector3f(bO.M11, bO.M12, bO.M13);
                }
            }
            else
            {
            ...
            {
                distance = tl - rarb;
                axis = new Vector3f(bO.M21, bO.M22, bO.M23);
                return false;
            }
            if (tl < -rarb)
            {
            ...
            if (tl > 0)
            {
                ...
                {
                    minimumDistance = tempDistance;
                    minimumAxis = new Vector3f(bO.M21, bO.M22, bO.M23);
                }
            }
            else
            {
            ...
            {
                distance = tl - rarb;
                axis = new Vector3f(bO.M31, bO.M32, bO.M33);
                return false;
            }
            if (tl < -rarb)
            {
            ...
            if (tl > 0)
            {
                ...
                {
                    minimumDistance = tempDistance;
                    minimumAxis = new Vector3f(bO.M31, bO.M32, bO.M33);
                }
            }
            else
            {
            ...
            {
                distance = tl - rarb;
                axis = new Vector3f(aO.M12 * bO.M13 - aO.M13 * bO.M12,
                                   aO.M13 * bO.M11 - aO.M11 * bO.M13,
                                   aO.M11 * bO.M12 - aO.M12 * bO.M11);
                return false;
            }
            ...
            {
                distance = -tl - rarb;
                axis = new Vector3f(bO.M12 * aO.M13 - bO.M13 * aO.M12,
                                   bO.M13 * aO.M11 - bO.M11 * aO.M13,
                                   bO.M11 * aO.M12 - bO.M12 * aO.M11);
                return false;
            }
            ...
            if (tl > 0)
            {
                tempAxis = new Vector3f(aO.M12 * bO.M13 - aO.M13 * bO.M12,
                                       aO.M13 * bO.M11 - aO.M11 * bO.M13,
                                       aO.M11 * bO.M12 - aO.M12 * bO.M11);
            ...
            {
                tempAxis = new Vector3f(bO.M12 * aO.M13 - bO.M13 * aO.M12,
                                       bO.M13 * aO.M11 - bO.M11 * aO.M13,
                                       bO.M11 * aO.M12 - bO.M12 * aO.M11);
                axisLengthInverse = 1 / tempAxis.Length;
                tempDistance = (-tl - rarb) * axisLengthInverse;
            ...
            {
                distance = tl - rarb;
                axis = new Vector3f(aO.M12 * bO.M23 - aO.M13 * bO.M22,
                                   aO.M13 * bO.M21 - aO.M11 * bO.M23,
                                   aO.M11 * bO.M22 - aO.M12 * bO.M21);
                return false;
            }
            ...
            {
                distance = -tl - rarb;
                axis = new Vector3f(bO.M22 * aO.M13 - bO.M23 * aO.M12,
                                   bO.M23 * aO.M11 - bO.M21 * aO.M13,
                                   bO.M21 * aO.M12 - bO.M22 * aO.M11);
                return false;
            }
            ...
            if (tl > 0)
            {
                tempAxis = new Vector3f(aO.M12 * bO.M23 - aO.M13 * bO.M22,
                                       aO.M13 * bO.M21 - aO.M11 * bO.M23,
                                       aO.M11 * bO.M22 - aO.M12 * bO.M21);
                axisLengthInverse = 1 / tempAxis.Length;
                tempDistance = (tl - rarb) * axisLengthInverse;
            ...
            {
                tempAxis = new Vector3f(bO.M22 * aO.M13 - bO.M23 * aO.M12,
                                       bO.M23 * aO.M11 - bO.M21 * aO.M13,
                                       bO.M21 * aO.M12 - bO.M22 * aO.M11);
                axisLengthInverse = 1 / tempAxis.Length;
                tempDistance = (-tl - rarb) * axisLengthInverse;
            ...
            {
                distance = tl - rarb;
                axis = new Vector3f(aO.M12 * bO.M33 - aO.M13 * bO.M32,
                                   aO.M13 * bO.M31 - aO.M11 * bO.M33,
                                   aO.M11 * bO.M32 - aO.M12 * bO.M31);
                return false;
            }
            ...
            {
                distance = -tl - rarb;
                axis = new Vector3f(bO.M32 * aO.M13 - bO.M33 * aO.M12,
                                   bO.M33 * aO.M11 - bO.M31 * aO.M13,
                                   bO.M31 * aO.M12 - bO.M32 * aO.M11);
                return false;
            }
            ...
            if (tl > 0)
            {
                tempAxis = new Vector3f(aO.M12 * bO.M33 - aO.M13 * bO.M32,
                                       aO.M13 * bO.M31 - aO.M11 * bO.M33,
                                       aO.M11 * bO.M32 - aO.M12 * bO.M31);
                axisLengthInverse = 1 / tempAxis.Length;
                tempDistance = (tl - rarb) * axisLengthInverse;
            ...
            {
                tempAxis = new Vector3f(bO.M32 * aO.M13 - bO.M33 * aO.M12,
                                       bO.M33 * aO.M11 - bO.M31 * aO.M13,
                                       bO.M31 * aO.M12 - bO.M32 * aO.M11);
                axisLengthInverse = 1 / tempAxis.Length;
                tempDistance = (-tl - rarb) * axisLengthInverse;
            ...
            {
                distance = tl - rarb;
                axis = new Vector3f(aO.M22 * bO.M13 - aO.M23 * bO.M12,
                                   aO.M23 * bO.M11 - aO.M21 * bO.M13,
                                   aO.M21 * bO.M12 - aO.M22 * bO.M11);
                return false;
            }
            ...
            {
                distance = -tl - rarb;
                axis = new Vector3f(bO.M12 * aO.M23 - bO.M13 * aO.M22,
                                   bO.M13 * aO.M21 - bO.M11 * aO.M23,
                                   bO.M11 * aO.M22 - bO.M12 * aO.M21);
                return false;
            }
            ...
            if (tl > 0)
            {
                tempAxis = new Vector3f(aO.M22 * bO.M13 - aO.M23 * bO.M12,
                                       aO.M23 * bO.M11 - aO.M21 * bO.M13,
                                       aO.M21 * bO.M12 - aO.M22 * bO.M11);
                axisLengthInverse = 1 / tempAxis.Length;
                tempDistance = (tl - rarb) * axisLengthInverse;
            ...
            {
                tempAxis = new Vector3f(bO.M12 * aO.M23 - bO.M13 * aO.M22,
                                       bO.M13 * aO.M21 - bO.M11 * aO.M23,
                                       bO.M11 * aO.M22 - bO.M12 * aO.M21);
                axisLengthInverse = 1 / tempAxis.Length;
                tempDistance = (-tl - rarb) * axisLengthInverse;
            ...
            {
                distance = tl - rarb;
                axis = new Vector3f(aO.M22 * bO.M23 - aO.M23 * bO.M22,
                                   aO.M23 * bO.M21 - aO.M21 * bO.M23,
                                   aO.M21 * bO.M22 - aO.M22 * bO.M21);
                return false;
            }
            ...
            {
                distance = -tl - rarb;
                axis = new Vector3f(bO.M22 * aO.M23 - bO.M23 * aO.M22,
                                   bO.M23 * aO.M21 - bO.M21 * aO.M23,
                                   bO.M21 * aO.M22 - bO.M22 * aO.M21);
                return false;
            }
            ...
            if (tl > 0)
            {
                tempAxis = new Vector3f(aO.M22 * bO.M23 - aO.M23 * bO.M22,
                                       aO.M23 * bO.M21 - aO.M21 * bO.M23,
                                       aO.M21 * bO.M22 - aO.M22 * bO.M21);
                axisLengthInverse = 1 / tempAxis.Length;
                tempDistance = (tl - rarb) * axisLengthInverse;
            ...
            {
                tempAxis = new Vector3f(bO.M22 * aO.M23 - bO.M23 * aO.M22,
                                       bO.M23 * aO.M21 - bO.M21 * aO.M23,
                                       bO.M21 * aO.M22 - bO.M22 * aO.M21);
                axisLengthInverse = 1 / tempAxis.Length;
                tempDistance = (-tl - rarb) * axisLengthInverse;
            ...
            {
                distance = tl - rarb;
                axis = new Vector3f(aO.M22 * bO.M33 - aO.M23 * bO.M32,
                                   aO.M23 * bO.M31 - aO.M21 * bO.M33,
                                   aO.M21 * bO.M32 - aO.M22 * bO.M31);
                return false;
            }
            ...
            {
                distance = -tl - rarb;
                axis = new Vector3f(bO.M32 * aO.M23 - bO.M33 * aO.M22,
                                   bO.M33 * aO.M21 - bO.M31 * aO.M23,
                                   bO.M31 * aO.M22 - bO.M32 * aO.M21);
                return false;
            }
            ...
            if (tl > 0)
            {
                tempAxis = new Vector3f(aO.M22 * bO.M33 - aO.M23 * bO.M32,
                                       aO.M23 * bO.M31 - aO.M21 * bO.M33,
                                       aO.M21 * bO.M32 - aO.M22 * bO.M31);
                axisLengthInverse = 1 / tempAxis.Length;
                tempDistance = (tl - rarb) * axisLengthInverse;
            ...
            {
                tempAxis = new Vector3f(bO.M32 * aO.M23 - bO.M33 * aO.M22,
                                       bO.M33 * aO.M21 - bO.M31 * aO.M23,
                                       bO.M31 * aO.M22 - bO.M32 * aO.M21);
                axisLengthInverse = 1 / tempAxis.Length;
                tempDistance = (-tl - rarb) * axisLengthInverse;
            ...
            {
                distance = tl - rarb;
                axis = new Vector3f(aO.M32 * bO.M13 - aO.M33 * bO.M12,
                                   aO.M33 * bO.M11 - aO.M31 * bO.M13,
                                   aO.M31 * bO.M12 - aO.M32 * bO.M11);
                return false;
            }
            ...
            {
                distance = -tl - rarb;
                axis = new Vector3f(bO.M12 * aO.M33 - bO.M13 * aO.M32,
                                   bO.M13 * aO.M31 - bO.M11 * aO.M33,
                                   bO.M11 * aO.M32 - bO.M12 * aO.M31);
                return false;
            }
            ...
            if (tl > 0)
            {
                tempAxis = new Vector3f(aO.M32 * bO.M13 - aO.M33 * bO.M12,
                                       aO.M33 * bO.M11 - aO.M31 * bO.M13,
                                       aO.M31 * bO.M12 - aO.M32 * bO.M11);
                axisLengthInverse = 1 / tempAxis.Length;
                tempDistance = (tl - rarb) * axisLengthInverse;
            ...
            {
                tempAxis = new Vector3f(bO.M12 * aO.M33 - bO.M13 * aO.M32,
                                       bO.M13 * aO.M31 - bO.M11 * aO.M33,
                                       bO.M11 * aO.M32 - bO.M12 * aO.M31);
                axisLengthInverse = 1 / tempAxis.Length;
                tempDistance = (-tl - rarb) * axisLengthInverse;
            ...
            {
                distance = tl - rarb;
                axis = new Vector3f(aO.M32 * bO.M23 - aO.M33 * bO.M22,
                                   aO.M33 * bO.M21 - aO.M31 * bO.M23,
                                   aO.M31 * bO.M22 - aO.M32 * bO.M21);
                return false;
            }
            ...
            {
                distance = -tl - rarb;
                axis = new Vector3f(bO.M22 * aO.M33 - bO.M23 * aO.M32,
                                   bO.M23 * aO.M31 - bO.M21 * aO.M33,
                                   bO.M21 * aO.M32 - bO.M22 * aO.M31);
                return false;
            }
            ...
            if (tl > 0)
            {
                tempAxis = new Vector3f(aO.M32 * bO.M23 - aO.M33 * bO.M22,
                                       aO.M33 * bO.M21 - aO.M31 * bO.M23,
                                       aO.M31 * bO.M22 - aO.M32 * bO.M21);
                axisLengthInverse = 1 / tempAxis.Length;
                tempDistance = (tl - rarb) * axisLengthInverse;
            ...
            {
                tempAxis = new Vector3f(bO.M22 * aO.M33 - bO.M23 * aO.M32,
                                       bO.M23 * aO.M31 - bO.M21 * aO.M33,
                                       bO.M21 * aO.M32 - bO.M22 * aO.M31);
                axisLengthInverse = 1 / tempAxis.Length;
                tempDistance = (-tl - rarb) * axisLengthInverse;
            ...
            {
                distance = tl - rarb;
                axis = new Vector3f(aO.M32 * bO.M33 - aO.M33 * bO.M32,
                                   aO.M33 * bO.M31 - aO.M31 * bO.M33,
                                   aO.M31 * bO.M32 - aO.M32 * bO.M31);
                return false;
            }
            ...
            {
                distance = -tl - rarb;
                axis = new Vector3f(bO.M32 * aO.M33 - bO.M33 * aO.M32,
                                   bO.M33 * aO.M31 - bO.M31 * aO.M33,
                                   bO.M31 * aO.M32 - bO.M32 * aO.M31);
                return false;
            }
            ...
            if (tl > 0)
            {
                tempAxis = new Vector3f(aO.M32 * bO.M33 - aO.M33 * bO.M32,
                                       aO.M33 * bO.M31 - aO.M31 * bO.M33,
                                       aO.M31 * bO.M32 - aO.M32 * bO.M31);
                axisLengthInverse = 1 / tempAxis.Length;
                tempDistance = (tl - rarb) * axisLengthInverse;
            ...
            {
                tempAxis = new Vector3f(bO.M32 * aO.M33 - bO.M33 * aO.M32,
                                       bO.M33 * aO.M31 - bO.M31 * aO.M33,
                                       bO.M31 * aO.M32 - bO.M32 * aO.M31);
                axisLengthInverse = 1 / tempAxis.Length;
                tempDistance = (-tl - rarb) * axisLengthInverse;
        ...
        /// <param name="transformB">Transform to apply to shape B.</param>
        /// <returns>Whether or not the boxes collide.</returns>
        public static unsafe bool AreBoxesColliding(BoxShape a, BoxShape b, ref RigidTransform transformA, ref RigidTransform transformB, out float distance, out Vector3f axis, out TinyStructList<BoxContactData> contactData)
        {
        ...
        /// <returns>Whether or not the boxes collide.</returns>
#if ALLOWUNSAFE
        public static bool AreBoxesColliding(BoxShape a, BoxShape b, ref RigidTransform transformA, ref RigidTransform transformB, out float distance, out Vector3f axis, out BoxContactDataCache contactData)
#else
        public static bool AreBoxesColliding(BoxShape a, BoxShape b, ref RigidTransform transformA, ref RigidTransform transformB, out float distance, out Vector3f axis, out TinyStructList<BoxContactData> contactData)
#endif
        {
            float aX = a.HalfWidth;
            float aY = a.HalfHeight;
...
#if ALLOWUNSAFE
        internal static void GetEdgeEdgeContact(BoxShape a, BoxShape b, ref Vector3f positionA, ref Matrix3f orientationA, ref Vector3f positionB, ref Matrix3f orientationB, float depth, ref Vector3f mtd, out BoxContactDataCache contactData)
#else
        internal static void GetEdgeEdgeContact(BoxShape a, BoxShape b, ref Vector3f positionA, ref Matrix3f orientationA, ref Vector3f positionB, ref Matrix3f orientationB, float depth, ref Vector3f mtd, out TinyStructList<BoxContactData> contactData)
#endif
        {
            ...
            Vector3f mtdA, mtdB;
            Vector3f negatedMtd;
            Vector3f.Negate(ref mtd, out negatedMtd);
            Vector3f.TransformTranspose(ref negatedMtd, ref orientationA, out mtdA);
            Vector3f.TransformTranspose(ref mtd, ref orientationB, out mtdB);


#if !WINDOWS
            Vector3f edgeAStart1 = new Vector3f(), edgeAEnd1 = new Vector3f(), edgeAStart2 = new Vector3f(), edgeAEnd2 = new Vector3f();
            Vector3f edgeBStart1 = new Vector3f(), edgeBEnd1 = new Vector3f(), edgeBStart2 = new Vector3f(), edgeBEnd2 = new Vector3f();
#else
            Vector3f edgeAStart1, edgeAEnd1, edgeAStart2, edgeAEnd2;
            Vector3f edgeBStart1, edgeBEnd1, edgeBStart2, edgeBEnd2;
#endif
            ...
            if (Math.Abs(mtdA.X) < MathHelper.Epsilon)
            {
            ...
            else if (Math.Abs(mtdA.Y) < MathHelper.Epsilon)
            {
            ...
            if (Math.Abs(mtdB.X) < MathHelper.Epsilon)
            {
                //mtd is in the Y-Z plane.
                //Perform an implicit dot with the edge location relative to the center.
            ...
            else if (Math.Abs(mtdB.Y) < MathHelper.Epsilon)
            {
                //mtd is in the X-Z plane
                //Perform an implicit dot with the edge location relative to the center.
                //Find the two edges furthest in the direction of the mtdB.
            ...
            Vector3f.Transform(ref edgeAStart1, ref orientationA, out edgeAStart1);
            Vector3f.Transform(ref edgeAEnd1, ref orientationA, out edgeAEnd1);
            Vector3f.Transform(ref edgeBStart1, ref orientationB, out edgeBStart1);
            Vector3f.Transform(ref edgeBEnd1, ref orientationB, out edgeBEnd1);

            Vector3f.Transform(ref edgeAStart2, ref orientationA, out edgeAStart2);
            Vector3f.Transform(ref edgeAEnd2, ref orientationA, out edgeAEnd2);
            Vector3f.Transform(ref edgeBStart2, ref orientationB, out edgeBStart2);
            Vector3f.Transform(ref edgeBEnd2, ref orientationB, out edgeBEnd2);

            Vector3f.Add(ref edgeAStart1, ref positionA, out edgeAStart1);
            Vector3f.Add(ref edgeAEnd1, ref positionA, out edgeAEnd1);
            Vector3f.Add(ref edgeBStart1, ref positionB, out edgeBStart1);
            Vector3f.Add(ref edgeBEnd1, ref positionB, out edgeBEnd1);

            Vector3f.Add(ref edgeAStart2, ref positionA, out edgeAStart2);
            Vector3f.Add(ref edgeAEnd2, ref positionA, out edgeAEnd2);
            Vector3f.Add(ref edgeBStart2, ref positionB, out edgeBStart2);
            Vector3f.Add(ref edgeBEnd2, ref positionB, out edgeBEnd2);
            ...
            {
                Vector3f.Subtract(ref onA, ref onB, out offset);
                Vector3f.Dot(ref offset, ref mtd, out dot);
        ...
        private static void GetEdgeData(int index, int axis, float x, float y, float z, out Vector3f edgeStart, out Vector3f edgeEnd, out int edgeStartId, out int edgeEndId)
        {
...
#if !WINDOWS
            edgeStart = new Vector3f();
            edgeEnd = new Vector3f();
#endif
        ...
        static bool GetClosestPointsBetweenSegments(ref Vector3f p1, ref Vector3f q1, ref Vector3f p2, ref Vector3f q2,
                                                           out Vector3f c1, out Vector3f c2)
        {
            //Segment direction vectors
            Vector3f d1;
            Vector3f.Subtract(ref q1, ref p1, out d1);
            Vector3f d2;
            Vector3f.Subtract(ref q2, ref p2, out d2);
            Vector3f r;
            Vector3f.Subtract(ref p1, ref p2, out r);
            //distance
            float a = d1.LengthSquared;
            float e = d2.LengthSquared;
            float f;
            Vector3f.Dot(ref d2, ref r, out f);
            ...
            Vector3f.Multiply(ref d1, s, out c1);
            Vector3f.Add(ref c1, ref p1, out c1);
            Vector3f.Multiply(ref d2, t, out c2);
            Vector3f.Add(ref c2, ref p2, out c2);
            return true;
        }

        //        internal static void GetEdgeEdgeContact(BoxShape a, BoxShape b, ref Vector3f positionA, ref Matrix3X3 orientationA, ref Vector3f positionB, ref Matrix3X3 orientationB, float depth, ref Vector3f mtd, out TinyStructList<BoxContactData> contactData)
        //        {
        //            //Put the minimum translation direction into the local space of each object.
        //            Vector3f mtdA, mtdB;
        //            Vector3f negatedMtd;
        ...
        //#if !WINDOWS
        //            Vector3f edgeA1 = new Vector3f(), edgeA2 = new Vector3f();
        //            Vector3f edgeB1 = new Vector3f(), edgeB2 = new Vector3f();
        //#else
        //            Vector3f edgeA1, edgeA2;
        //            Vector3f edgeB1, edgeB2;
        //#endif
        //            float aHalfWidth = a.halfWidth;
        //            float aHalfHeight = a.halfHeight;
        //            float aHalfLength = a.halfLength;
        ...
        //            Vector3f.Add(ref edgeA1, ref positionA, out edgeA1);
        //            Vector3f.Add(ref edgeA2, ref positionA, out edgeA2);
        //            Vector3f.Add(ref edgeB1, ref positionB, out edgeB1);
        //            Vector3f.Add(ref edgeB2, ref positionB, out edgeB2);

        //            float s, t;
        //            Vector3f onA, onB;
        //            Toolbox.GetClosestPointsBetweenSegments(ref edgeA1, ref edgeA2, ref edgeB1, ref edgeB2, out s, out t, out onA, out onB);
        //            //Vector3f.Add(ref onA, ref onB, out point);
        //            //Vector3f.Multiply(ref point, .5f, out point);
        //            point = onA;
...
#if ALLOWUNSAFE
        internal static void GetFaceContacts(BoxShape a, BoxShape b, ref Vector3f positionA, ref Matrix3f orientationA, ref Vector3f positionB, ref Matrix3f orientationB, bool aIsFaceOwner, ref Vector3f mtd, out BoxContactDataCache contactData)
#else
        internal static void GetFaceContacts(BoxShape a, BoxShape b, ref Vector3f positionA, ref Matrix3f orientationA, ref Vector3f positionB, ref Matrix3f orientationB, bool aIsFaceOwner, ref Vector3f mtd, out TinyStructList<BoxContactData> contactData)
#endif
        {
            float aHalfWidth = a.halfWidth;
            float aHalfHeight = a.halfHeight;
...
#if ALLOWUNSAFE
        private static unsafe void PruneContactsMaxDistance(ref Vector3f mtd, BoxContactDataCache input, out BoxContactDataCache output)
        {
            ...
            {
                float distance;
                Vector3f.DistanceSquared(ref data[deepestIndex].Position, ref data[i].Position, out distance);
            ...
            Vector3f xAxis;
            Vector3f.Subtract(ref data[furthestIndex].Position, ref data[deepestIndex].Position, out xAxis);

            Vector3f yAxis;
            Vector3f.Cross(ref mtd, ref xAxis, out yAxis);
            ...
            Vector3f.Dot(ref data[0].Position, ref yAxis, out minY);
            maxY = minY;
            for (int i = 1; i < count; i++)
            {
                float dot;
                Vector3f.Dot(ref yAxis, ref data[i].Position, out dot);
                if (dot < minY)
                {
                    minY = dot;
                    minYindex = i;
            ...
            //Vector3f v;
            //var maximumOffset = new Vector3f();
            ...
            //    {
            //        Vector3f.Subtract(ref data[j].Position, ref data[i].Position, out v);
            ...
            //Vector3f otherDirection;
            //Vector3f.Cross(ref mtd, ref maximumOffset, out otherDirection);
            ...
            //    {
            //        Vector3f.Dot(ref data[i].Position, ref otherDirection, out temp);
...
#else
        private static void PruneContactsMaxDistance(ref Vector3f mtd, TinyStructList<BoxContactData> input, out TinyStructList<BoxContactData> output)
        {
            int count = input.Count;
            //Find the deepest point.
            ...
            Vector3f.DistanceSquared(ref deepestData.Position, ref furthestData.Position, out furthestDistance);
            for (int i = 1; i < count; i++)
            {
                input.Get(i, out data);
                float distance;
                Vector3f.DistanceSquared(ref deepestData.Position, ref data.Position, out distance);
                if (distance > furthestDistance)
                {
                    furthestDistance = distance;
                    furthestData = data;
            ...
            Vector3f xAxis;
            Vector3f.Subtract(ref furthestData.Position, ref deepestData.Position, out xAxis);
            ...
            Vector3f.Dot(ref minData.Position, ref yAxis, out minY);
            maxY = minY;
            for (int i = 1; i < count; i++)
            {
                input.Get(i, out data);
                float dot;
                Vector3f.Dot(ref yAxis, ref data.Position, out dot);
                if (dot < minY)
                {
                    minY = dot;
                    minData = data;
            ...
            //        Vector3f.Subtract(ref itemB.Position, ref itemA.Position, out v);
            //        temp = v.LengthSquared();
            //        if (temp > maximumDistanceSquared)
            //        {
            //            maximumDistanceSquared = temp;
            ...
            //    {
            //        input.Get(i, out itemA);
            //        Vector3f.Dot(ref itemA.Position, ref otherDirection, out temp);
            //        if (temp > maximumDistance)
            //        {
            //            maximumDistance = temp;
            //            maximumIndex = i;
...
#if ALLOWUNSAFE
        private static unsafe void ClipFacesDirect(ref BoxFace clipFace, ref BoxFace face, ref Vector3f mtd, out BoxContactDataCache outputData)
        {
            ...
            Vector3f clipX, clipY;
            Vector3f.Subtract(ref clipFace.V4, ref clipFace.V3, out clipX);
            Vector3f.Subtract(ref clipFace.V2, ref clipFace.V3, out clipY);
            ...
            Vector3f faceX, faceY;
            Vector3f.Subtract(ref face.V4, ref face.V3, out faceX);
            Vector3f.Subtract(ref face.V2, ref face.V3, out faceY);
            ...
            Vector3f clipCenter;
            Vector3f.Add(ref clipFace.V1, ref clipFace.V3, out clipCenter);
            //Defer division until after dot product (2 multiplies instead of 3)
            float clipCenterX, clipCenterY;
            Vector3f.Dot(ref clipCenter, ref clipX, out clipCenterX);
            Vector3f.Dot(ref clipCenter, ref clipY, out clipCenterY);
            clipCenterX *= .5f;
            clipCenterY *= .5f;

            Vector3f faceCenter;
            Vector3f.Add(ref face.V1, ref face.V3, out faceCenter);
            //Defer division until after dot product (2 multiplies instead of 3)
            float faceCenterX, faceCenterY;
            Vector3f.Dot(ref faceCenter, ref faceX, out faceCenterX);
            Vector3f.Dot(ref faceCenter, ref faceY, out faceCenterY);
            faceCenterX *= .5f;
            faceCenterY *= .5f;
        ...
        #region Face Vertices
            ...
            Vector3f.Dot(ref clipFace.V1, ref mtd, out clipFaceDot);
            for (int i = 0; i < tempData.Count; i++)
            {
                Vector3f.Dot(ref temp[i].Position, ref mtd, out faceDot);
        ...
        #region Clip face vertices
            ...
            Vector3f v;
            float a, b;
            Vector3f.Dot(ref face.V1, ref face.Normal, out b);
            //CLIP FACE
            if (clipv1MinXInside && clipv1MaxXInside && clipv1MinYInside && clipv1MaxYInside)
            {
                Vector3f.Dot(ref clipFace.V1, ref face.Normal, out a);
                Vector3f.Multiply(ref face.Normal, a - b, out v);
                Vector3f.Subtract(ref clipFace.V1, ref v, out v);
            ...
            {
                Vector3f.Dot(ref clipFace.V2, ref face.Normal, out a);
                Vector3f.Multiply(ref face.Normal, a - b, out v);
                Vector3f.Subtract(ref clipFace.V2, ref v, out v);
                data[contactData.Count].Position = v;
            ...
            {
                Vector3f.Dot(ref clipFace.V3, ref face.Normal, out a);
                Vector3f.Multiply(ref face.Normal, a - b, out v);
                Vector3f.Subtract(ref clipFace.V3, ref v, out v);
                data[contactData.Count].Position = v;
            ...
            {
                Vector3f.Dot(ref clipFace.V4, ref face.Normal, out a);
                Vector3f.Multiply(ref face.Normal, a - b, out v);
                Vector3f.Subtract(ref clipFace.V4, ref v, out v);
                data[contactData.Count].Position = v;
        ...
        #region CLIP EDGE: v1 v2
            ...
            if (!v1MaxYInside)
            {
                if (v2MaxYInside)
                {
                    ...
                    //Vector3f.Dot(ref clipX, ref v, out dot);
        ...
        #region CLIP EDGE: v2 v3
            ...
            if (!v1MinXInside)
            {
                if (v2MinXInside && contactData.Count < 8)
                {
                    ...
                    //ComputeIntersection(ref face.V1, ref face.V2, ref clipEdge, out v);
                    //Vector3f.Dot(ref clipY, ref v, out dot);
...
#else
        private static void ClipFacesDirect(ref BoxFace clipFace, ref BoxFace face, ref Vector3f mtd, out TinyStructList<BoxContactData> contactData)
        {
            contactData = new TinyStructList<BoxContactData>();
            ...
            for (int i = 0; i < tempData.Count; i++)
            {
                ...
                Vector3f.Dot(ref item.Position, ref mtd, out faceDot);
        ...
        //    Vector3f faceNormal;
        //    Vector3f.Cross(ref faceY, ref faceX, out faceNormal);
        ...
        //    Vector3f v;
        //    float a, b;
        //    Vector3f.Dot(ref face.V1, ref faceNormal, out b);
        //    //CLIP FACE
        //    if (clipv1MinXInside && clipv1MaxXInside && clipv1MinYInside && clipv1MaxYInside)
        //    {
        //        Vector3f.Dot(ref clipFace.V1, ref faceNormal, out a);
        //        Vector3f.Multiply(ref faceNormal, a - b, out v);
        //        Vector3f.Subtract(ref clipFace.V1, ref v, out v);
        //        item.Position = v;
        //        item.Id = clipFace.Id1 + 8;
        //        contactData.Add(ref item);
        ...
        //    if (clipv2MinXInside && clipv2MaxXInside && clipv2MinYInside && clipv2MaxYInside)
        //    {
        //        Vector3f.Dot(ref clipFace.V2, ref faceNormal, out a);
        //        Vector3f.Multiply(ref faceNormal, a - b, out v);
        //        Vector3f.Subtract(ref clipFace.V2, ref v, out v);
        //        item.Position = v;
        //        item.Id = clipFace.Id2 + 8;
        ...
        //    if (clipv3MinXInside && clipv3MaxXInside && clipv3MinYInside && clipv3MaxYInside)
        //    {
        //        Vector3f.Dot(ref clipFace.V3, ref faceNormal, out a);
        //        Vector3f.Multiply(ref faceNormal, a - b, out v);
        //        Vector3f.Subtract(ref clipFace.V3, ref v, out v);
        //        item.Position = v;
        //        item.Id = clipFace.Id3 + 8;
        ...
        //    if (clipv4MinXInside && clipv4MaxXInside && clipv4MinYInside && clipv4MaxYInside)
        //    {
        //        Vector3f.Dot(ref clipFace.V4, ref faceNormal, out a);
        //        Vector3f.Multiply(ref faceNormal, a - b, out v);
        //        Vector3f.Subtract(ref clipFace.V4, ref v, out v);
        //        item.Position = v;
        //        item.Id = clipFace.Id4 + 8;
        ...
        private static bool ComputeIntersection(ref Vector3f edgeA1, ref Vector3f edgeA2, ref FaceEdge clippingEdge, out Vector3f intersection)
        {
            ...
            Vector3f offset;
            Vector3f.Subtract(ref clippingEdge.A, ref edgeA1, out offset);

            Vector3f edgeDirection;
            Vector3f.Subtract(ref edgeA2, ref edgeA1, out edgeDirection);
            float distanceToPlane;
            Vector3f.Dot(ref offset, ref clippingEdge.Perpendicular, out distanceToPlane);
            float edgeDirectionLength;
            Vector3f.Dot(ref edgeDirection, ref clippingEdge.Perpendicular, out edgeDirectionLength);
            ...
            Vector3f.Multiply(ref edgeDirection, t, out offset);
            Vector3f.Add(ref offset, ref edgeA1, out intersection);

            Vector3f.Subtract(ref intersection, ref clippingEdge.A, out offset);
            Vector3f.Subtract(ref clippingEdge.B, ref clippingEdge.A, out edgeDirection);
            Vector3f.Dot(ref edgeDirection, ref offset, out t);
        ...
        private static void GetNearestFace(ref Vector3f position, ref Matrix3f orientation, ref Vector3f mtd, float halfWidth, float halfHeight, float halfLength, out BoxFace boxFace)
        {
            boxFace = new BoxFace();
            ...
            Matrix3f.ToMatrix4f(ref orientation, out worldTransform);
            ...
            if (absX > absY && absX > absZ)
            {
                ...
                if (xDot < 0)
                {
                    ...
                    bit = 1;
                candidate = new Vector3f(halfWidth, halfHeight, halfLength);
                Vector3f.Transform(ref candidate, ref worldTransform, out candidate);
        ...
        private struct BoxFace
        {
            ...
            public void GetVertex(int i, out Vector3f v)
            {
                switch (i)
                {
                    case 0:
            ...
            internal void GetEdge(int i, out FaceEdge clippingEdge)
            {
                ...
                Vector3f.Cross(ref edgeDirection, ref Normal, out clippingEdge.Perpendicular);

                float dot;
                Vector3f offset;
                Vector3f.Subtract(ref insidePoint, ref clippingEdge.A, out offset);
                Vector3f.Dot(ref clippingEdge.Perpendicular, ref offset, out dot);
                if (dot > 0)
                {
                ...
                Vector3f.Dot(ref clippingEdge.A, ref clippingEdge.Perpendicular, out clippingEdge.EdgeDistance);
            }
        }
        ...
        private struct FaceEdge : IEquatable<FaceEdge>
        {
            ...
            public bool IsPointInside(ref Vector3f point)
            {
                float distance;
                Vector3f.Dot(ref point, ref Perpendicular, out distance);

...
using AlienEngine.Core.Physics.BroadPhaseSystems.Hierarchies;
...
using AlienEngine.Core.Physics.NarrowPhaseSystems;
...
namespace AlienEngine.Core.Physics
{
    ...
    public class Space
    {
        ...
        public bool ConvexCast(ConvexShape castShape, ref RigidTransform startingTransform, ref Vector3f sweep, out RayCastResult castResult)
        {
        ...
        /// <param name="castResult">Hit data, if any.</param>
        /// <returns>Whether or not the cast hit anything.</returns>
        public bool ConvexCast(ConvexShape castShape, ref RigidTransform startingTransform, ref Vector3f sweep, Func<BroadPhaseEntry, bool> filter, out RayCastResult castResult)
        {
            var castResults = PhysicsResources.GetRayCastResultList();
        ...
        /// <returns>Whether or not the cast hit anything.</returns>
        public bool ConvexCast(ConvexShape castShape, ref RigidTransform startingTransform, ref Vector3f sweep, IList<RayCastResult> outputCastResults)
        {
        ...
        /// <param name="outputCastResults">Hit data, if any.</param>
        /// <returns>Whether or not the cast hit anything.</returns>
        public bool ConvexCast(ConvexShape castShape, ref RigidTransform startingTransform, ref Vector3f sweep, Func<BroadPhaseEntry, bool> filter, IList<RayCastResult> outputCastResults)
        {
            var overlappedElements = PhysicsResources.GetBroadPhaseEntryList();
            BoundingBox boundingBox;
            castShape.GetSweptBoundingBox(ref startingTransform, ref sweep, out boundingBox);

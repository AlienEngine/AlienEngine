...
namespace AlienEngine.Core.Physics.CollisionShapes
{
    ...
    public struct CompoundShapeEntry
    {
        ...
        public CompoundShapeEntry(EntityShape shape, Vector3f position, float weight)
        {
            position.Validate();
        ...
        ///<param name="shape">Shape to use.</param>
        ///<param name="position">Local position of the shape.</param>
        public CompoundShapeEntry(EntityShape shape, Vector3f position)
        {
            position.Validate();
            LocalTransform = new RigidTransform(position);
            Shape = shape;
    ...
    public class CompoundShape : EntityShape
    {
        ...
        public CompoundShape(IList<CompoundShapeEntry> shapes, out Vector3f center)
        {
            if (shapes.Count > 0)
            {
                float volume;

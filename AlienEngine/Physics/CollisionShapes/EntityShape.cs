...
namespace AlienEngine.Core.Physics.CollisionShapes
{
    ...
    public abstract class EntityShape : CollisionShape
    {
        ...
        internal Matrix3f volumeDistribution;
        /// <summary>
        ...
        /// </summary>
        public Matrix3f VolumeDistribution
        {
        ...
        protected void TransformLocalExtremePoints(ref Vector3f x, ref Vector3f y, ref Vector3f z, ref Matrix3f transform, out Vector3f result)
        {

...
namespace AlienEngine.Core.Physics.CollisionShapes.ConvexShapes
{
    ...
    public abstract class ConvexShape : EntityShape
    {
        ...
        ///<param name="direction">Direction to find the extreme point in.</param>
        ///<param name="extremePoint">Extreme point on the shape.</param>
        public void GetLocalExtremePoint(Vector3f direction, out Vector3f extremePoint)
        {
            GetLocalExtremePointWithoutMargin(ref direction, out extremePoint);
        ...
        public override void GetBoundingBox(ref RigidTransform shapeTransform, out BoundingBox boundingBox)
        {
            ...
            Vector3f left;
            direction = new Vector3f(-o.M11, -o.M21, -o.M31);
        ...
        public void GetLocalBoundingBox(ref RigidTransform shapeTransform, ref AffineTransform spaceTransform, out BoundingBox boundingBox)
        {
            ...
            Vector3f right;
            var direction = new Vector3f(transform.LinearTransform.M11, transform.LinearTransform.M21, transform.LinearTransform.M31);
            GetLocalExtremePoint(direction, out right);

            Vector3f left;
            direction = new Vector3f(-transform.LinearTransform.M11, -transform.LinearTransform.M21, -transform.LinearTransform.M31);
            GetLocalExtremePoint(direction, out left);

            Vector3f up;
            direction = new Vector3f(transform.LinearTransform.M12, transform.LinearTransform.M22, transform.LinearTransform.M32);
            ...
            Vector3f backward;
            direction = new Vector3f(transform.LinearTransform.M13, transform.LinearTransform.M23, transform.LinearTransform.M33);

...
namespace AlienEngine.Core.Physics.CollisionShapes.ConvexShapes
{
    ...
    public class ConeShape : ConvexShape
    {
        ...
        public override void GetLocalExtremePointWithoutMargin(ref Vector3f direction, out Vector3f extremePoint)
        {
            ...
            {
                extremePoint = new Vector3f(0, .75f * height, 0);
                return;
            }
            ...
            if (horizontalLengthSquared > MathHelper.Epsilon)
            {
                ...
                extremePoint = new Vector3f((float)(radOverSigma * direction.X), -.25f * height, (float)(radOverSigma * direction.Z));
            }
            else // It's pointing almost straight down...
                extremePoint = new Vector3f(0, -.25f * height, 0);

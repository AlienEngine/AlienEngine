...
namespace AlienEngine.Core.Physics.Vehicle
{
    ...
    public class WheelSuspension : ISpringSettings, ISolverSettings
    {
        ...
        internal Vector3f localAttachmentPoint;
        internal Vector3f localDirection;
        ...
        private Wheel wheel;
        internal Vector3f worldAttachmentPoint;
        internal Vector3f worldDirection;
        ...
        public WheelSuspension(float stiffnessConstant, float dampingConstant, Vector3f localDirection, float restLength, Vector3f localAttachmentPoint)
        {
        ...
        /// </summary>
        public Vector3f LocalAttachmentPoint
        {
        ...
        /// </summary>
        public Vector3f WorldAttachmentPoint
        {
        ...
        public Vector3f LocalDirection
        {
            ...
            set
            {
                localDirection = Vector3f.Normalize(value);
                if (wheel != null)
                    wheel.shape.Initialize();
                if (wheel != null && wheel.vehicle != null)
                    Vector3f.Transform(ref localDirection, ref wheel.vehicle.Body.orientationMatrix, out worldDirection);
                else
        ...
        public Vector3f WorldDirection
        {
            ...
            set
            {
                worldDirection = Vector3f.Normalize(value);
                if (wheel != null)
                    wheel.shape.Initialize();
                if (wheel != null && wheel.vehicle != null)
                    Vector3f.TransformTranspose(ref worldDirection, ref wheel.Vehicle.Body.orientationMatrix, out localDirection);
                else
        ...
        internal void PreStep(float dt)
        {
            ...
            //Vector3f.TransformNormal(ref myLocalDirection, ref parentA.myInternalOrientationMatrix, out myWorldDirection);

...
namespace AlienEngine.Core.Physics.Vehicle
{
    ...
    public class Wheel
    {
        ...
        internal Vector3f localForwardDirection = new Vector3f(0, 0, -1);
        ...
        internal PhysicsMaterial supportMaterial;
        internal Vector3f supportLocation;
        internal Entity supportingEntity;
        internal WheelSuspension suspension;
        internal Vehicle vehicle;
        internal Vector3f worldForwardDirection;
        ...
        /// </summary>
        public Vector3f LocalForwardDirection
        {
            get { return localForwardDirection; }
            set
            {
                localForwardDirection = Vector3f.Normalize(value);
                if (vehicle != null)
                    Vector3f.Transform(ref localForwardDirection, ref Vehicle.Body.orientationMatrix, out worldForwardDirection);
                else
        ...
        /// </summary>
        public Vector3f SupportLocation
        {
        ...
        /// </summary>
        public PhysicsMaterial SupportMaterial
        {
            get
            {
        ...
        /// </summary>
        public Vector3f WorldForwardDirection
        {
            get { return worldForwardDirection; }
            set
            {
                worldForwardDirection = Vector3f.Normalize(value);
                if (vehicle != null)
                {
                    Quaternion conjugate;
                    Quaternion.Conjugate(ref Vehicle.Body.orientation, out conjugate);
                    Vector3f.Transform(ref worldForwardDirection, ref conjugate, out localForwardDirection);
                }
                else

...
namespace AlienEngine.Core.Physics.Vehicle
{
    ...
    public abstract class WheelShape : ICollisionRulesOwner
    {
        ...
        /// </summary>
        protected internal Box detector = new Box(Vector3f.Zero, 0, 0, 0);

        protected internal Matrix4f localGraphicTransform;
        ...
        internal Matrix4f steeringTransform;
        protected internal Wheel wheel;

        protected internal Matrix4f worldTransform;
        ...
        /// </summary>
        public Matrix4f LocalGraphicTransform
        {

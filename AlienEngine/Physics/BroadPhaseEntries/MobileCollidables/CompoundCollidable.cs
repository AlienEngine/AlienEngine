...
using AlienEngine.Core.Physics.BroadPhaseEntries.Events;
    ...
    public class CompoundCollidable : EntityCollidable
    {
        ...
        private CompoundChild GetChild(CompoundChildData data, int index)
        {
            ...
            if (data.Material == null)
                data.Material = new PhysicsMaterial();
        ...
        public override void UpdateWorldTransform(ref Vector3f position, ref Quaternion orientation)
        {
        ...
        public override bool ConvexCast(CollisionShapes.ConvexShapes.ConvexShape castShape, ref RigidTransform startingTransform, ref Vector3f sweep, out RayHit rayHit)
        {
            CompoundChild hitChild;
        ...
        /// <returns>Whether or not the cast hit anything.</returns>
        public bool ConvexCast(CollisionShapes.ConvexShapes.ConvexShape castShape, ref RigidTransform startingTransform, ref Vector3f sweep, out RayCastResult result)
        {
            CompoundChild hitChild;
            RayHit rayHit;
            bool hit = ConvexCast(castShape, ref startingTransform, ref sweep, out rayHit, out hitChild);
        ...
        /// <returns>Whether or not the cast hit anything.</returns>
        public bool ConvexCast(CollisionShapes.ConvexShapes.ConvexShape castShape, ref RigidTransform startingTransform, ref Vector3f sweep, out RayHit hit, out CompoundChild hitChild)
        {
            hit = new RayHit();
            hitChild = null;
        ...
        /// <param name="rayHit">Hit data, if any.</param>
        /// <returns>Whether or not the cast hit anything.</returns>
        public override bool ConvexCast(CollisionShapes.ConvexShapes.ConvexShape castShape, ref RigidTransform startingTransform, ref Vector3f sweep, Func<BroadPhaseEntry, bool> filter, out RayHit rayHit)
        {
            CompoundChild hitChild;
        ...
        /// <param name="result">Data and hit object from the first impact, if any.</param>
        /// <returns>Whether or not the cast hit anything.</returns>
        public bool ConvexCast(CollisionShapes.ConvexShapes.ConvexShape castShape, ref RigidTransform startingTransform, ref Vector3f sweep, Func<BroadPhaseEntry, bool> filter, out RayCastResult result)
        {
            CompoundChild hitChild;
            RayHit rayHit;
            bool hit = ConvexCast(castShape, ref startingTransform, ref sweep, filter, out rayHit, out hitChild);
        ...
        /// <param name="hitChild">Child hit by the cast.</param>
        /// <returns>Whether or not the cast hit anything.</returns>
        public bool ConvexCast(CollisionShapes.ConvexShapes.ConvexShape castShape, ref RigidTransform startingTransform, ref Vector3f sweep, Func<BroadPhaseEntry, bool> filter, out RayHit hit, out CompoundChild hitChild)
        {
            hit = new RayHit();
            hitChild = null;
            if (!filter(this))

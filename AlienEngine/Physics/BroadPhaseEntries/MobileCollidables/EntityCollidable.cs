    ...
    public abstract class EntityCollidable : MobileCollidable
    {
        ...
        public RigidTransform WorldTransform
        {
            ...
            set
            {
                ...
                Vector3f.Transform(ref localPosition, ref conjugate, out worldOffset);
                Vector3f.Subtract(ref value.Position, ref worldOffset, out value.Position);
        ...
        protected internal Vector3f localPosition;
        ///<summary>
        ...
        public virtual void UpdateWorldTransform(ref Vector3f position, ref Quaternion orientation)
        {
            Vector3f.Transform(ref localPosition, ref orientation, out worldTransform.Position);
            Vector3f.Add(ref worldTransform.Position, ref position, out worldTransform.Position);

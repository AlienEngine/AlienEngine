    ...
    public class Terrain : StaticCollidable
    {
        ...
        public AffineTransform WorldTransform
        {
            ...
            set
            {
                ...
                Matrix3f.AdjugateTranspose(ref worldTransform.LinearTransform, out normalTransform);

                //If the world 'up' doesn't match the normal 'up', some reflection occurred which requires a winding flip.
                if (Vector3f.Dot(normalTransform.Up, worldTransform.LinearTransform.Up) < 0)
                {
        ...
        public float Thickness
        {
            ...
            set
            {
                ...
                Vector3f down = Vector3f.Normalize(worldTransform.LinearTransform.Down);
                Vector3f thicknessOffset = down * (value - thickness);
        ...
        public override void UpdateBoundingBox()
        {
            ...
            Vector3f thicknessOffset = Vector3f.Normalize(worldTransform.LinearTransform.Down) * thickness;
        ...
        public void GetPosition(int i, int j, out Vector3f position)
        {

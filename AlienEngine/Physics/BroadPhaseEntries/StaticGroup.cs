...
namespace AlienEngine.Core.Physics.BroadPhaseEntries
{
    ...
    public class StaticGroup : StaticCollidable
    {
        ...
        /// <param name="hit">Hit data, if any.</param>
        /// <returns>Whether or not the cast hit anything.</returns>
        public override bool ConvexCast(ConvexShape castShape, ref RigidTransform startingTransform, ref Vector3f sweep, Func<BroadPhaseEntry, bool> filter, out RayHit hit)
        {
            RayCastResult result;

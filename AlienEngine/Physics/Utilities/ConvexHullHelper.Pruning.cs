...
namespace AlienEngine.Core.Physics.Utilities
{
    public static partial class ConvexHullHelper
    {
        ...
        public static void RemoveRedundantPoints(IList<Vector3f> points)
        {
        ...
        public static void RemoveRedundantPoints(IList<Vector3f> points, double cellSize)
        {
        ...
        /// </summary>
        /// <param name="points">List of points to prune.</param>
        public static void RemoveRedundantPoints(RawList<Vector3f> points)
        {
            RemoveRedundantPoints(points, .001);
        }
        ...
        /// <param name="points">List of points to prune.</param>
        /// <param name="cellSize">Size of cells to determine redundancy.</param>
        public static void RemoveRedundantPoints(RawList<Vector3f> points, double cellSize)
        {

...
namespace AlienEngine.Core.Resources
{
    ...
    public static class CommonResources
    {
        ...
        public static void ResetPools()
        {
            ...
            SubPoolVectorList = new LockingResourcePool<RawList<Vector3f>>();
        ...
        static LockingResourcePool<RawList<Vector3f>> SubPoolVectorList;
        ...
        /// <summary>
        /// Retrieves a Vector3f list from the resource pool.
        /// </summary>
        /// <returns>Empty Vector3f list.</returns>
        public static RawList<Vector3f> GetVectorList()
        {
        ...
        /// </summary>
        /// <param name="list">List to return.</param>
        public static void GiveBack(RawList<Vector3f> list)
        {
            list.Clear();

    ...
    public class ListBox : UIContainer
    {
        ...
        public IFont Font
        {
            ...
            set
            {
                ...
                font = value;
                text = new Text(Shaders.FontShader, font, dropDownBox.SelectedLineText, UI.Font.Alignement.Left);
                text.RelativeTo = Corner.TopLeft;
                text.Position = new Point2i(0, text.TextSize.Y);
            }
        }
        #endregion
        ...
        public ListBox(Texture dropDownIcon, Texture scrollTexture, BMFont font, string[] items, int selectedLine = 0)
        {
            ...
            this.dropDownToggle.Position = new Point2i(0, (this.Size.Y - this.dropDownToggle.Size.Y)/ 2);
        ...
        public override void Invalidate()
        {
            ...
            dropDownBox.Size = new Sizei(this.Size.X - 8, (int)Math.Round(font.Height * numLines * 1.2));
            dropDownBox.Position = new Point2i(this.Position.X, this.Position.Y + this.Size.Y);

            if (dropDownBox.RelativeTo == Corner.Center) dropDownBox.Position = new Point2i(dropDownBox.Position.X, (-this.Size.Y - dropDownBox.Size.Y) / 2);
            this.dropDownToggle.Position = new Point2i(0, (this.Size.Y - this.dropDownToggle.Size.Y) / 2);
        }
        #endregion
    }

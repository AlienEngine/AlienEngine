...
namespace AlienEngine.UI
{
    public class TextBox : UIElement
    {
        ...
        private class TextBoxEntry
        {
            ...
            public TextBoxEntry(Color3 color, string text, IFont font, bool newLine = true, int position = 0)
            {
                this.Color = color;
                this.Text = text;
        ...
        public void UpdateScrollBar()
        {
            ...
            scrollBar.RelativeTo = Corner.BottomLeft;
            scrollBar.Position = CorrectedPosition - Parent.CorrectedPosition + new Point2i(Size.X, y);
        ...
        {
            this.Font = font;
            this.SelectedColor = new Color4(0.3f, 0.9f, 0.3f, 1f);
            ...
            this.scrollBar.BackgroundColor = new Color4(0, 0, 0, 0);
            this.scrollBar.Size = new Sizei(scrollBar.Size.X, scrollBar.Size.Y / 2);
            ...
            scrollBar.OnMouseDown = new OnMouse((sender, eventArgs) =>
                {
                    scrollBarMouseDown = (eventArgs.Button == Input.MouseButton.LeftClick);
            ...
            scrollBar.OnMouseMove = new OnMouse((sender, eventArgs) =>
            {
                ...
                scrollBarDown = eventArgs.Location.Y;
                scrollBar.Position = new Point2i(scrollBar.Position.X, y);
                scrollBar.OnResize();
        ...
        private void BuildVAO(TextBoxEntry entry, string text)
        {
            ...
            temp.Padding = new Sizei(entry.Position, 0);
            vaos.Add(temp);
        }
        #endregion
        ...
        public override void OnResize()
        {
            ...
            VBO<Vector3f> vertex = new VBO<Vector3f>(new Vector3f[] { new Vector3f(0, 0, 0), new Vector3f(Size.X, 0, 0), new Vector3f(Size.X, Font.Height * 1.2f, 0), new Vector3f(0, Font.Height * 1.2f, 0) });
        ...
        public override void Draw()
        {
            ...
            {
                if (OnTextVisible != null) OnTextVisible(this, new MouseEventArgs(new Point2i(0, 0)));
                VisibleCharacters = 0;
            }
            ...
            for (int i = 0, v = 0; i < lines.Count - CurrentLine && v < vaos.Count; i++)
            {
                if (AllowSelection && (currentLine + i) == SelectedLine && selectedVAO != null)
                {
                    ...
                    Shaders.SolidUIShader.SetUniform("position", new Vector3f(CorrectedPosition.X, CorrectedPosition.Y - (1.2f * (i + 1) * Font.Height - Size.Y), 0));
                    Shaders.SolidUIShader.SetUniform("color", SelectedColor);
                ...
                for (int j = 0; j < lines[i + CurrentLine].Count; j++)
                {
                    ...
                    vaos[v].CorrectedPosition = new Point2i(CorrectedPosition.X + Padding.X, (int)(CorrectedPosition.Y - (1.2 * (i + 1) * Font.Height - Size.Y)));
        ...
        {
            WriteLine(Color3.White, (string)message);
        }

    ...
    public class Slider : UIContainer
    {
        ...
        public int Value
        {
            ...
            set
            {
                ...
                sliderButton.Position = new Point2i(x, 0);
        ...
        public Slider(Texture sliderTexture, int min = 0, int max = 10, int value = 0)
            : base(new Point2i(0, 0), new Sizei(200, sliderTexture.Size.Height), "Slider" + UserInterface.GetUniqueElementID())
        {
            this.min = min;
            this.max = max;
            this.value = value;
            ...
            sliderButton.BackgroundColor = new Color4(0, 0, 0, 0);

            sliderButton.OnMouseUp = (sender, eventArgs) => sliderMouseDown = false;
            sliderButton.OnMouseDown = (sender, eventArgs) =>
            {
                sliderMouseDown = (eventArgs.Button == Input.MouseButton.LeftClick);
            ...
            sliderButton.Position = new Point2i(value * (Size.X - sliderButton.Size.X) / (max - min), 0);

...
namespace AlienEngine.UI
{
    public class ColorGradient : UIElement
    {
        ...
        public float Hue
        {
            ...
            set
            {
                h = value;
                Program.Bind();
                Program.SetUniform("hue", new HSLColor(value, 1, 0.5f).ToVector());
                UpdateColor();
            }
        }
        ...
        public ColorGradient()
        {
            ...
            this.Program.Bind();
            this.Program.SetUniform("hue", new Vector3f(h, 0, 0));
            this.Program.SetUniform("sel", new Vector2f(selx, sely));
            this.gradientQuad = Geometry.CreateQuad(this.Program, Vector2f.Zero, new Vector2f(150, 150));

            this.RelativeTo = Corner.TopLeft;
            this.Position = new Point2i(30, 50);
            this.Size = new Sizei(150, 150);
            ...
            {
                mouseDown = (eventArgs.Button == Input.MouseButton.LeftClick);
                UpdateMousePosition(eventArgs.Location.X, eventArgs.Location.Y);
            });
            this.OnMouseUp = new OnMouse((sender, eventArgs) => mouseDown = (eventArgs.Button == Input.MouseButton.LeftClick ? false : mouseDown));
        ...
        private void UpdateMousePosition(int x, int y)
        {
            ...
            Program.Bind();
            Program.SetUniform("sel", new Vector2f(selx, sely));
        ...
        private void UpdateColor()
        {
            ...
            Vector3f color = new HSLColor(h, 1, 0.5f).ToVector();

            // now blend the white and color together
            Vector3f blend1 = color * selx + Vector3f.One * (float)(1 - selx);
        ...
        public override void OnResize()
        {
            ...
            Program.Bind();
            Program.SetUniform("model_matrix", Matrix4f.CreateTranslation(new Vector3f(CorrectedPosition.X, CorrectedPosition.Y, 0)));
        }
    ...
    public class HueGradient : UIElement
    {
        ...
        public HueGradient()
        {
            ...
            this.Program.Bind();
            this.Program.SetUniform("hue", 0f);
            this.hueQuad = Geometry.CreateQuad(this.Program, Vector2f.Zero, new Vector2f(26, 150));

            this.RelativeTo = Corner.TopLeft;
            this.Position = new Point2i(185, 50);
            this.Size = new Sizei(26, 150);
        ...
        private void UpdateMousePosition(int x, int y)
        {
            ...
            Program.Bind();
            Program.SetUniform("hue", (float)((UserInterface.Height - y) - CorrectedPosition.Y));

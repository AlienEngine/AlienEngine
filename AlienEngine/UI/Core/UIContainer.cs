...
namespace AlienEngine.UI
{
    public class UIContainer : UIElement
    {
        ...
        #region Constructor
        public UIContainer()
            : this(new Point2i(0, 0), UserInterface.UIWindow.Size, "Container" + UserInterface.GetUniqueElementID())
        {
            this.RelativeTo = Corner.Fill;
        }

        public UIContainer(Sizei Size, string Name)
            : this(new Point2i(0, 0), Size, Name)
        {
        }

        public UIContainer(Point2i Position, Sizei Size, string Name)
        {
        ...
        public UIElement PickChildren(Point2i Location)
        {

...
namespace AlienEngine.Core.Graphics.GLFW
{
    static partial class GLFW
    {
        ...
        public static unsafe string GetVersionString() => GLFW.FromUTF8(glfwGetVersionString());
        ...
        /// This function may be called before <see cref="Init"/>.
        /// </remarks>
        public static void SetErrorCallback(GLFW.ErrorFunc callback) => glfwSetErrorCallback(Marshal.GetFunctionPointerForDelegate(callback));
        ...
        public static unsafe GLFW.Monitor[] GetMonitors()
        {
            int count;
            ...
            var monitors = new GLFW.Monitor[count];
            int size = Marshal.SizeOf(typeof(IntPtr));

            for (int i = 0; i < count; i++)
            {
                var ptr = Marshal.ReadIntPtr(array, i * size);
                monitors[i] = new GLFW.Monitor(ptr);
            }
        ...
        public static extern GLFW.Monitor GetPrimaryMonitor();
        ...
        public static unsafe void GetMonitorPos(GLFW.Monitor monitor, out int xpos, out int ypos)
        {
            int xx, yy;
        ...
        /// </remarks>
        public static unsafe void GetMonitorPhysicalSize(GLFW.Monitor monitor, out int widthMM, out int heightMM)
        {
            int ww, hh;
        ...
        /// occurred.</returns>
        public static unsafe string GetMonitorName(GLFW.Monitor monitor) => GLFW.FromUTF8(glfwGetMonitorName(monitor.Ptr));
        ...
        /// <param name="callback">The new callback, or <c>null</c> to remove the currently set
        /// callback.</param>
        public static void SetMonitorCallback(GLFW.MonitorFunc callback) => glfwSetMonitorCallback(Marshal.GetFunctionPointerForDelegate(callback));
        ...
        /// <seealso cref="GetVideoMode(GLFW.Monitor)"/>
        public static unsafe GLFW.VideoMode[] GetVideoModes(GLFW.Monitor monitor)
        {
            int count;
            ...
            var result = new GLFW.VideoMode[count];
        ...
        [DllImport(Library, CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
        static extern unsafe GLFW.VideoMode* glfwGetVideoModes(IntPtr monitor, int* count);
        ...
        /// <seealso cref="GetVideoModes(GLFW.Monitor)"/>
        public static GLFW.VideoMode GetVideoMode(GLFW.Monitor monitor)
        {
            var ptr = glfwGetVideoMode(monitor.Ptr);
            return (GLFW.VideoMode)Marshal.PtrToStructure(ptr, typeof(GLFW.VideoMode));
        }
        ...
        /// calls <see cref="SetGammaRamp(GLFW.Monitor, GLFW.GammaRamp)"/> with it. The value must be a finite
        /// number greater than zero.
        /// </summary>
        /// <param name="monitor">The monitor whose gamma ramp to set.</param>
        /// <param name="gamma">The desired exponent.</param>
        public static void SetGamma(GLFW.Monitor monitor, float gamma) => glfwSetGamma(monitor.Ptr, gamma);
        ...
        public static unsafe GLFW.GammaRamp GetGammaRamp(GLFW.Monitor monitor)
        {
        ...
        [DllImport(Library, CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
        static extern unsafe GLFW.InternalGammaRamp* glfwGetGammaRamp(IntPtr monitor);
        ...
        /// </remarks>
        public static unsafe void SetGammaRamp(GLFW.Monitor monitor, GLFW.GammaRamp ramp)
        {
            fixed (ushort* rampRed = ramp.Red, rampBlue = ramp.Blue, rampGreen = ramp.Green)
            {
                var internalRamp = new GLFW.InternalGammaRamp
                {
                    Red = rampRed,
                    Blue = rampBlue,
                    Green = rampGreen,
        ...
        [DllImport(Library, CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
        static extern void glfwSetGammaRamp(IntPtr monitor, GLFW.InternalGammaRamp ramp);

        /// <summary>
        /// This function resets all window hints to their default values.
        /// </summary>
        /// <seealso cref="WindowHint(GLFW.Hint, bool)"/>
        /// <seealso cref="WindowHint(GLFW.Hint, Enum)"/>
        /// <seealso cref="WindowHint(GLFW.Hint, int)"/>
        ...
        /// until changed by a call to <see cref="WindowHint(GLFW.Hint, int)"/> or
        ...
        public static void WindowHint(GLFW.Hint hint, bool value) => glfwWindowHint((int)hint, value ? 1 : 0);
        ...
        /// <param name="value">The new value of the window hint.</param>
        /// <seealso cref="DefaultWindowHints"/>
        public static void WindowHint(GLFW.Hint hint, int value)
        {
            if (value < 0)
                value = GLFW.DontCare;
        ...
        /// <param name="value">The new value of the window hint.</param>
        /// <seealso cref="DefaultWindowHints"/>
        public static void WindowHint(GLFW.Hint hint, Enum value) => glfwWindowHint((int)hint, Convert.ToInt32(value));
        ...
        /// window, framebuffer and context see <see cref="GetWindowAttrib(GLFW.Window, GLFW.WindowAttrib)"/>,
        /// <see cref="GetWindowSize(GLFW.Window, out int, out int)"/> and
        /// <see cref="GetFramebufferSize(GLFW.Window, out int, out int)"/>.</para>
        ...
        /// the <see cref="GLFW.Hint.Visible"/> hint, set its position and then show it.</para>
        /// <para>As long as at least one full screen window is not iconified, the screensaver is
        /// prohibited from starting.</para>
        /// <para>GLFW.Window systems put limits on window sizes. Very large or very small window
        ...
        /// occurred.</returns>
        /// <remarks>
        /// <para><strong>Win32:</strong> GLFW.Window creation will fail if the Microsoft GDI software
        ...
        /// <see cref="SetWindowIcon(GLFW.Window, GLFW.Image)"/>.</para>
        ...
        /// </remarks>
        /// <seealso cref="DestroyWindow(GLFW.Window)"/>
        public static GLFW.Window CreateWindow(int width, int height, string title, GLFW.Monitor? monitor = null, GLFW.Window? share = null)
            => glfwCreateWindow(
                width,
                height,
                GLFW.ToUTF8(title),
        ...
        [DllImport(Library, CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
        [return: MarshalAs(UnmanagedType.Struct)]
        static extern GLFW.Window glfwCreateWindow(int width, int height, IntPtr title, IntPtr monitor, IntPtr share);
        ...
        /// <seealso cref="CreateWindow(int, int, string, GLFW.Monitor, GLFW.Window)"/>
        [DllImport(Library, CallingConvention = CallingConvention.Cdecl, EntryPoint = "glfwDestroyWindow"), SuppressUnmanagedCodeSecurity]
        public static extern void DestroyWindow([MarshalAs(UnmanagedType.Struct)] GLFW.Window window);
        ...
        [return: MarshalAs(UnmanagedType.Bool)]
        public static extern bool WindowShouldClose([MarshalAs(UnmanagedType.Struct)] GLFW.Window window);
        ...
        public static extern void SetWindowShouldClose([MarshalAs(UnmanagedType.Struct)] GLFW.Window window, [MarshalAs(UnmanagedType.Bool)] bool value);
        ...
        /// process events.
        /// </remarks>
        public static void SetWindowTitle(GLFW.Window window, string title) => glfwSetWindowTitle(window.Ptr, GLFW.ToUTF8(title));
        ...
        /// </remarks>
        public static void SetWindowIcon(GLFW.Window window, GLFW.Image image) => SetWindowIcon(window, new GLFW.Image[] { image });
        ...
        /// Bundle Programming Guide</a> in the Mac Developer Library.
        /// </remarks>
        public static unsafe void SetWindowIcon(GLFW.Window window, GLFW.Image[] images)
        {
            if (images == null)
            {
            ...
            var imgs = new GLFW.InternalImage[images.Length];

            for (int i = 0; i < imgs.Length; i++)
            {
                int size = images[i].Width * images[i].Width * 4;

                imgs[i] = new GLFW.InternalImage
                {
                ...
                Marshal.Copy(images[i].Pixels, 0, imgs[i].Pixels, System.Math.Min(size, images[i].Pixels.Length));
            }

            IntPtr ptr;
            fixed (GLFW.InternalImage* array = imgs)
        ...
        /// client area.</param>
        /// <seealso cref="SetWindowPos(GLFW.Window, int, int)"/>
        public static unsafe void GetWindowPos(GLFW.Window window, out int xpos, out int ypos)
        {
            int xx, yy;
        ...
        /// <seealso cref="GetWindowPos(GLFW.Window, out int, out int)"/>
        [DllImport(Library, CallingConvention = CallingConvention.Cdecl, EntryPoint = "glfwSetWindowPos"), SuppressUnmanagedCodeSecurity]
        public static extern void SetWindowPos([MarshalAs(UnmanagedType.Struct)] GLFW.Window window, int xpos, int ypos);
        ...
        /// pixels, see <see cref="GetFramebufferSize(GLFW.Window, out int, out int)"/>.
        /// </summary>
        ...
        /// area.</param>
        /// <seealso cref="SetWindowSize(GLFW.Window, int, int)"/>
        public static unsafe void GetWindowSize(GLFW.Window window, out int width, out int height)
        {
            int w, h;
        ...
        /// </remarks>
        /// <seealso cref="SetWindowAspectRatio(GLFW.Window, int, int)"/>
        ...
        public static extern void SetWindowSizeLimits([MarshalAs(UnmanagedType.Struct)] GLFW.Window window, int minwidth, int minheight, int maxwidth, int maxheight);
        ...
        /// <para>If the numerator and denominator is set to <see cref="GLFW.DontCare"/> then the aspect
        ...
        /// If you set size limits and an aspect ratio that conflict, the results are undefined.
        /// </remarks>
        /// <seealso cref="SetWindowSizeLimits(GLFW.Window, int, int, int, int)"/>
        ...
        public static extern void SetWindowAspectRatio([MarshalAs(UnmanagedType.Struct)] GLFW.Window window, int numer, int denom);
        ...
        /// area.</param>
        /// <seealso cref="GetWindowSize(GLFW.Window, out int, out int)"/>
        /// <seealso cref="SetWindowMonitor(GLFW.Window, GLFW.Monitor, int, int, int, int, int)"/>
        [DllImport(Library, CallingConvention = CallingConvention.Cdecl, EntryPoint = "glfwSetWindowSize"), SuppressUnmanagedCodeSecurity]
        public static extern void SetWindowSize([MarshalAs(UnmanagedType.Struct)] GLFW.Window window, int width, int height);

        /// <summary>
        /// This function retrieves the size, in pixels, of the framebuffer of the specified window.
        /// If you wish to retrieve the size of the window in screen coordinates, see
        /// <see cref="GetWindowSize(GLFW.Window, out int, out int)"/>.
        /// </summary>
        ...
        /// <seealso cref="SetFramebufferSizeCallback(GLFW.Window, GLFW.FramebufferSizeFunc)"/>
        public static unsafe void GetFramebufferSize(GLFW.Window window, out int width, out int height)
        {
            int w, h;
        ...
        public static unsafe void GetWindowFrameSize(GLFW.Window window, out int left, out int top, out int right, out int bottom)
        {
            int l, t, r, b;
        ...
        /// <seealso cref="RestoreWindow(GLFW.Window)"/>
        /// <seealso cref="MaximizeWindow(GLFW.Window)"/>
        [DllImport(Library, CallingConvention = CallingConvention.Cdecl, EntryPoint = "glfwIconifyWindow"), SuppressUnmanagedCodeSecurity]
        public static extern void IconifyWindow([MarshalAs(UnmanagedType.Struct)] GLFW.Window window);
        ...
        /// <seealso cref="IconifyWindow(GLFW.Window)"/>
        /// <seealso cref="MaximizeWindow(GLFW.Window)"/>
        [DllImport(Library, CallingConvention = CallingConvention.Cdecl, EntryPoint = "glfwRestoreWindow"), SuppressUnmanagedCodeSecurity]
        public static extern void RestoreWindow([MarshalAs(UnmanagedType.Struct)] GLFW.Window window);
        ...
        public static extern void MaximizeWindow([MarshalAs(UnmanagedType.Struct)] GLFW.Window window);
        ...
        /// <seealso cref="HideWindow(GLFW.Window)"/>
        [DllImport(Library, CallingConvention = CallingConvention.Cdecl, EntryPoint = "glfwShowWindow"), SuppressUnmanagedCodeSecurity]
        public static extern void ShowWindow([MarshalAs(UnmanagedType.Struct)] GLFW.Window window);
        ...
        /// <seealso cref="ShowWindow(GLFW.Window)"/>
        [DllImport(Library, CallingConvention = CallingConvention.Cdecl, EntryPoint = "glfwHideWindow"), SuppressUnmanagedCodeSecurity]
        public static extern void HideWindow([MarshalAs(UnmanagedType.Struct)] GLFW.Window window);
        ...
        /// created. Set the <see cref="GLFW.Hint.Focused"/> hint to disable this behavior.</para>
        ...
        public static extern void FocusWindow([MarshalAs(UnmanagedType.Struct)] GLFW.Window window);
        ...
        /// </summary>
        /// <param name="window">The window to query.</param>
        /// <returns>The monitor, or <see cref="GLFW.Monitor.None"/> if the window is in windowed mode or
        /// an error occurred.</returns>
        /// <seealso cref="SetWindowMonitor(GLFW.Window, GLFW.Monitor, int, int, int, int, int)"/>
        public static GLFW.Monitor GetWindowMonitor(GLFW.Window window)
        {
            var ptr = glfwGetWindowMonitor(window.Ptr);
            return new GLFW.Monitor(ptr);
        }
        ...
        /// the monitor is <see cref = "GLFW.Monitor.None" />, makes it windowed mode.</para>
        ...
        /// <para>When the monitor is <see cref = "GLFW.Monitor.None" />, the position, width and height
        ...
        /// windowed mode window, see <see cref="SetWindowSize(GLFW.Window, int, int)"/>"/>.</para>
        ...
        /// <param name="monitor">The desired monitor, or <see cref="GLFW.Monitor.None"/> to set windowed
        /// mode.</param>
        ...
        /// <see cref="GLFW.DontCare"/>.</param>
        /// <seealso cref="GetWindowMonitor(GLFW.Window)"/>
        /// <seealso cref="SetWindowSize(GLFW.Window, int, int)"/>
        ...
        public static extern void SetWindowMonitor([MarshalAs(UnmanagedType.Struct)] GLFW.Window window, [MarshalAs(UnmanagedType.Struct)] GLFW.Monitor monitor, int xpos, int ypos, int width, int height, int refreshRate);
        ...
        /// </remarks>
        public static bool GetWindowAttrib(GLFW.Window window, GLFW.WindowAttrib attrib) => glfwGetWindowAttrib(window.Ptr, Convert.ToInt32(attrib)) != 0;
        ...
        /// <seealso cref="GetWindowUserPointer(GLFW.Window)"/>
        ...
        public static extern void SetWindowUserPointer([MarshalAs(UnmanagedType.Struct)] GLFW.Window window, IntPtr ptr);
        ...
        /// <seealso cref="SetWindowUserPointer(GLFW.Window, IntPtr)"/>
        ...
        public static extern IntPtr GetWindowUserPointer([MarshalAs(UnmanagedType.Struct)] GLFW.Window window);
        ...
        /// <param name="callback">The new callback, or <c>null</c> to remove the currently set
        /// callback.</param>
        public static void SetWindowPosCallback(GLFW.Window window, GLFW.WindowPosFunc callback) => glfwSetWindowPosCallback(window.Ptr, Marshal.GetFunctionPointerForDelegate(callback));
        ...
        /// <param name="callback">The new callback, or <c>null</c> to remove the currently set
        /// callback.</param>
        public static void SetWindowSizeCallback(GLFW.Window window, GLFW.WindowSizeFunc callback) => glfwSetWindowSizeCallback(window.Ptr, Marshal.GetFunctionPointerForDelegate(callback));
        ...
        /// time with <see cref="SetWindowShouldClose(GLFW.Window, bool)"/>.</para>
        /// <para>The close callback is not triggered by <see cref="DestroyWindow(GLFW.Window)"/>.</para>
        /// </summary>
        /// <param name="window">The window whose callback to set.</param>
        /// <param name="callback">The new callback, or <c>null</c> to remove the currently set
        /// callback.</param>
        ...
        /// </remarks>
        public static void SetWindowCloseCallback(GLFW.Window window, GLFW.WindowCloseFunc callback) => glfwSetWindowCloseCallback(window.Ptr, Marshal.GetFunctionPointerForDelegate(callback));
        ...
        /// <param name="callback">The new callback, or <c>null</c> to remove the currently set
        /// callback.</param>
        public static void SetWindowRefreshCallback(GLFW.Window window, GLFW.WindowRefreshFunc callback) => glfwSetWindowRefreshCallback(window.Ptr, Marshal.GetFunctionPointerForDelegate(callback));
        ...
        /// pressed. For more information, see <see cref="SetKeyCallback(GLFW.Window, GLFW.KeyFunc)"/> and
        /// <see cref="SetMouseButtonCallback(GLFW.Window, GLFW.MouseButtonFunc)"/>.</para>
        /// </summary>
        /// <param name="window">The window whose callback to set.</param>
        /// <param name="callback">The new callback, or <c>null</c> to remove the currently set
        /// callback.</param>
        public static void SetWindowFocusCallback(GLFW.Window window, GLFW.WindowFocusFunc callback) => glfwSetWindowFocusCallback(window.Ptr, Marshal.GetFunctionPointerForDelegate(callback));
        ...
        /// <param name="callback">The new callback, or <c>null</c> to remove the currently set
        /// callback.</param>
        public static void SetWindowIconifyCallback(GLFW.Window window, GLFW.WindowIconifyFunc callback) => glfwSetWindowIconifyCallback(window.Ptr, Marshal.GetFunctionPointerForDelegate(callback));
        ...
        /// <param name="callback">The new callback, or <c>null</c> to remove the currently set
        /// callback.</param>
        public static void SetFramebufferSizeCallback(GLFW.Window window, GLFW.FramebufferSizeFunc callback) => glfwSetFramebufferSizeCallback(window.Ptr, Marshal.GetFunctionPointerForDelegate(callback));
        ...
        /// </summary>
        /// <param name="window">The window to query.</param>
        /// <param name="mode">One of <see cref="GLFW.InputMode"/>.</param>
        /// <returns>The value of an input option for the specified window.</returns>
        public static int GetInputMode(GLFW.Window window, GLFW.InputMode mode) => glfwGetInputMode(window.Ptr, Convert.ToInt32(mode));
        ...
        /// <para>If the mode is <see cref="GLFW.InputMode.GLFW.Cursor"/>, the value must be one of the
        /// following cursor modes:</para>
        /// <list type="bullet">
        ///     <item><see cref="GLFW.CursorMode.Normal"/> makes the cursor visible and behaving
        ///     normally.</item>
        ///     <item><see cref="GLFW.CursorMode.Hidden"/> makes the cursor invisible when it is over the
        ///     client area of the window but does not restrict the cursor from leaving.</item>
        ///     <item><see cref="GLFW.CursorMode.Disabled"/> hides and grabs the cursor, providing
        ...
        /// <seealso cref="GetInputMode(GLFW.Window, GLFW.InputMode)"/>
        public static void SetInputMode(GLFW.Window window, GLFW.InputMode mode, GLFW.CursorMode value) => glfwSetInputMode(window.Ptr, Convert.ToInt32(mode), Convert.ToInt32(value));
        ...
        /// <param name="value">The new value of the specified input mode.</param>
        /// <seealso cref="GetInputMode(GLFW.Window, GLFW.InputMode)"/>
        public static void SetInputMode(GLFW.Window window, GLFW.InputMode mode, bool value) => glfwSetInputMode(window.Ptr, Convert.ToInt32(mode), value ? 1 : 0);
        ...
        /// <para>If the key is <see cref="GLFW.KeyCode.Unknown"/>, the scancode is used instead,
        /// otherwise the scancode is ignored. If a non-printable key or (if the key is
        /// <see cref="GLFW.KeyCode.Unknown"/>) a scancode that maps to a non-printable key is specified,
        ...
        /// <list type="bullet">
        ///     <item><see cref="GLFW.KeyCode.Apostrophe"/></item>
        ///     <item><see cref="GLFW.KeyCode.Comma"/></item>
        ///     <item><see cref="GLFW.KeyCode.Minus"/></item>
        ///     <item><see cref="GLFW.KeyCode.Period"/></item>
        ///     <item><see cref="GLFW.KeyCode.Slash"/></item>
        ///     <item><see cref="GLFW.KeyCode.SemiColon"/></item>
        ///     <item><see cref="GLFW.KeyCode.Equal"/></item>
        ///     <item><see cref="GLFW.KeyCode.LeftBracket"/></item>
        ///     <item><see cref="GLFW.KeyCode.RightBracket"/></item>
        ///     <item><see cref="GLFW.KeyCode.Backslash"/></item>
        ///     <item><see cref="GLFW.KeyCode.World1"/></item>
        ///     <item><see cref="GLFW.KeyCode.World2"/></item>
        ///     <item><see cref="GLFW.KeyCode.Alpha0"/> to <see cref="GLFW.KeyCode.Alpha9"/></item>
        ///     <item><see cref="GLFW.KeyCode.A"/> to <see cref="GLFW.KeyCode.Z"/></item>
        ///     <item><see cref="GLFW.KeyCode.Numpad0"/> to <see cref="GLFW.KeyCode.Numpad9"/></item>
        ///     <item><see cref="GLFW.KeyCode.NumpadDecimal"/></item>
        ///     <item><see cref="GLFW.KeyCode.NumpadDivide"/></item>
        ///     <item><see cref="GLFW.KeyCode.NumpadMultiply"/></item>
        ///     <item><see cref="GLFW.KeyCode.NumpadSubtract"/></item>
        ///     <item><see cref="GLFW.KeyCode.NumpadAdd"/></item>
        ///     <item><see cref="GLFW.KeyCode.NumpadEqual"/></item>
        /// </list>
        /// </summary>
        ...
        /// <para>If the cursor is disabled (with <see cref="GLFW.CursorMode.Disabled"/>) then the cursor
        ...
        /// <seealso cref="SetCursorPos(GLFW.Window, double, double)"/>
        public static unsafe void GetCursorPos(GLFW.Window window, out double xpos, out double ypos)
        {
            double xx, yy;
        ...
        /// controls. GLFW already provides the <see cref = "GLFW.CursorMode.Disabled" /> cursor mode
        /// that hides the cursor, transparently re-centers it and provides unconstrained cursor
        /// motion. See <see cref="SetInputMode(GLFW.Window, GLFW.InputMode, GLFW.CursorMode)"/> for more
        /// information.</para>
        /// <para>If the cursor mode is <see cref = "GLFW.CursorMode.Disabled" /> then the cursor
        ...
        /// area.</param>
        /// <seealso cref="GetCursorPos(GLFW.Window, out double, out double)"/>
        [DllImport(Library, CallingConvention = CallingConvention.Cdecl, EntryPoint = "glfwSetCursorPos"), SuppressUnmanagedCodeSecurity]
        public static extern void SetCursorPos([MarshalAs(UnmanagedType.Struct)] GLFW.Window window, double xpos, double ypos);

        /// <summary>
        /// <para>Creates a new custom cursor image that can be set for a window with
        /// <see cref="SetCursor(GLFW.Window, GLFW.Cursor)"/>. The cursor can be destroyed with
        /// <see cref="DestroyCursor(GLFW.Cursor)"/>. Any remaining cursors are destroyed by
        ...
        /// <seealso cref="DestroyCursor(GLFW.Cursor)"/>
        /// <seealso cref="CreateStandardCursor(GLFW.CursorType)"/>
        public static unsafe GLFW.Cursor CreateCursor(GLFW.Image image, int xhot, int yhot)
        {
            int size = image.Width * image.Width * 4;

            var img = new GLFW.InternalImage
            {
                Width = image.Width,
                Height = image.Width,
                Pixels = Marshal.AllocHGlobal(size)
            ...
            Marshal.Copy(image.Pixels, 0, img.Pixels, System.Math.Min(size, image.Pixels.Length));
        ...
        /// <see cref="CreateCursor(GLFW.Image, int, int)"/>.
        /// </summary>
        ...
        /// <see cref="CreateCursor(GLFW.Image, int, int)"/>. Any remaining cursors will be destroyed by
        /// <see cref="Terminate"/>.
        /// </summary>
        /// <param name="cursor">The cursor object to destroy.</param>
        /// <seealso cref="CreateCursor(GLFW.Image, int, int)"/>
        [DllImport(Library, CallingConvention = CallingConvention.Cdecl, EntryPoint = "glfwDestroyCursor"), SuppressUnmanagedCodeSecurity]
        public static extern void DestroyCursor([MarshalAs(UnmanagedType.Struct)] GLFW.Cursor cursor);
        ...
        /// of the window is <see cref="GLFW.CursorMode.Normal"/>.</para>
        ...
        [DllImport(Library, CallingConvention = CallingConvention.Cdecl, EntryPoint = "glfwSetCursor"), SuppressUnmanagedCodeSecurity]
        public static extern void SetCursor([MarshalAs(UnmanagedType.Struct)] GLFW.Window window, [MarshalAs(UnmanagedType.Struct)] GLFW.Cursor cursor);
        ...
        /// use the <see cref="SetCharCallback(GLFW.Window, GLFW.CharFunc)"/> instead.</para>
        ...
        /// after the <see cref="SetWindowFocusCallback(GLFW.Window, GLFW.WindowFocusFunc)"/> has been
        /// called.</para>
        ...
        /// token. Such keys have <c>key</c> set to <see cref="GLFW.KeyCode.Unknown"/>, their state is
        /// not saved and so it cannot be queried with <see cref="GetKey(GLFW.Window, int)"/>.</para>
        ...
        /// <param name="callback">The new callback, or <c>null</c> to remove the currently set
        /// callback.</param>
        public static void SetKeyCallback(GLFW.Window window, GLFW.KeyFunc callback) { if (callback != null) glfwSetKeyCallback(window.Ptr, Marshal.GetFunctionPointerForDelegate(callback)); else glfwSetKeyCallback(window.Ptr, IntPtr.Zero); }
        ...
        /// <see cref="SetKeyCallback(GLFW.Window, GLFW.KeyFunc)"/> is not. Characters do not map 1:1 to
        ...
        /// <see cref="SetCharModsCallback(GLFW.Window, GLFW.CharModsFunc)"/> that receives these
        /// events.</para>
        /// </summary>
        /// <param name="window">The window whose callback to set.</param>
        /// <param name="callback">The new callback, or <c>null</c> to remove the currently set
        /// callback.</param>
        public static void SetCharCallback(GLFW.Window window, GLFW.CharFunc callback) { if (callback != null) glfwSetCharCallback(window.Ptr, Marshal.GetFunctionPointerForDelegate(callback)); else glfwSetCharCallback(window.Ptr, IntPtr.Zero); }
        ...
        /// <see cref="SetCharCallback(GLFW.Window, GLFW.CharFunc)"/>. Like the character callback, the
        ...
        /// released, see <see cref="SetKeyCallback(GLFW.Window, GLFW.KeyFunc)"/> instead.</para>
        /// </summary>
        /// <param name="window">The window whose callback to set.</param>
        /// <param name="callback">The new callback, or <c>null</c> to remove the currently set
        /// callback.</param>
        public static void SetCharModsCallback(GLFW.Window window, GLFW.CharModsFunc callback) => glfwSetCharModsCallback(window.Ptr, Marshal.GetFunctionPointerForDelegate(callback));
        ...
        /// been processed, i.e. after <see cref="SetWindowFocusCallback(GLFW.Window, GLFW.WindowFocusFunc)"/>
        /// has been called.</para>
        /// </summary>
        /// <param name="window">The window whose callback to set.</param>
        /// <param name="callback">The new callback, or <c>null</c> to remove the currently set
        /// callback.</param>
        public static void SetMouseButtonCallback(GLFW.Window window, GLFW.MouseButtonFunc callback) => glfwSetMouseButtonCallback(window.Ptr, Marshal.GetFunctionPointerForDelegate(callback));
        ...
        /// <param name="callback">The new callback, or <c>null</c> to remove the currently set
        /// callback.</param>
        public static void SetCursorPosCallback(GLFW.Window window, GLFW.CursorPosFunc callback) { if (callback != null) glfwSetCursorPosCallback(window.Ptr, Marshal.GetFunctionPointerForDelegate(callback)); else glfwSetCursorPosCallback(window.Ptr, IntPtr.Zero); }
        ...
        /// <param name="callback">The new callback, or <c>null</c> to remove the currently set
        /// callback.</param>
        public static void SetCursorEnterCallback(GLFW.Window window, GLFW.CursorEnterFunc callback) => glfwSetCursorEnterCallback(window.Ptr, Marshal.GetFunctionPointerForDelegate(callback));
        ...
        /// <param name="callback">The new callback, or <c>null</c> to remove the currently set
        /// callback.</param>
        public static void SetScrollCallback(GLFW.Window window, GLFW.CursorPosFunc callback) => glfwSetScrollCallback(window.Ptr, Marshal.GetFunctionPointerForDelegate(callback));
        ...
        /// <param name="callback">The new callback, or <c>null</c> to remove the currently set
        /// callback.</param>
        public static void SetDropCallback(GLFW.Window window, GLFW.DropFunc callback) => glfwSetDropCallback(window.Ptr, Marshal.GetFunctionPointerForDelegate(callback));
        ...
        /// this function to return <c>null</c>. Call <see cref="JoystickPresent(GLFW.Joystick)"/> to
        ...
        /// <param name="callback">The new callback, or <c>null</c> to remove the currently set
        /// callback.</param>
        public static void SetJoystickCallback(GLFW.JoystickFunc callback) => glfwSetJoystickCallback(Marshal.GetFunctionPointerForDelegate(callback));
        ...
        /// <seealso cref="GetClipboardString(GLFW.Window)"/>
        public static void SetClipboardString(GLFW.Window window, string value) => glfwSetClipboardString(window.Ptr, GLFW.ToUTF8(value));
        ...
        /// error occurred.</returns>
        /// <seealso cref="SetClipboardString(GLFW.Window, string)"/>
        public static string GetClipboardString(GLFW.Window window) => GLFW.FromUTF8(glfwGetClipboardString(window.Ptr));
        ...
        [DllImport(Library, CallingConvention = CallingConvention.Cdecl, EntryPoint = "glfwGetTime"), SuppressUnmanagedCodeSecurity]
        ...
        /// future.
        /// </remarks>
        [DllImport(Library, CallingConvention = CallingConvention.Cdecl, EntryPoint = "glfwSetTime"), SuppressUnmanagedCodeSecurity]
        ...
        [DllImport(Library, CallingConvention = CallingConvention.Cdecl, EntryPoint = "glfwGetTimerValue"), SuppressUnmanagedCodeSecurity]
        ...
        [DllImport(Library, CallingConvention = CallingConvention.Cdecl, EntryPoint = "glfwGetTimerFrequency"), SuppressUnmanagedCodeSecurity]
        ...
        /// context performs this flush by setting the <see cref="GLFW.Hint.ContextReleaseBehavior"/>
        /// window hint.</para>
        ...
        /// <see cref="GLFW.Window.None"/> to detach the current context.</param>
        ...
        public static extern void MakeContextCurrent([MarshalAs(UnmanagedType.Struct)] GLFW.Window window);

        /// <summary>
        /// This function returns the window whose OpenGL or OpenGL ES context is current on the
        /// calling thread.
        /// </summary>
        /// <returns>The window whose context is current, or <see cref="GLFW.Window.None"/> if no
        /// window's context is current.</returns>
        /// <seealso cref="MakeContextCurrent(GLFW.Window)"/>
        ...
        [return: MarshalAs(UnmanagedType.Struct)]
        public static extern GLFW.Window GetCurrentContext();
        ...
        public static extern void SwapBuffers([MarshalAs(UnmanagedType.Struct)] GLFW.Window window);
        ...
        /// <see cref="SwapBuffers(GLFW.Window)"/> was called before swapping the buffers and returning.
        ...
        /// buffers are swapped by <see cref="SwapBuffers(GLFW.Window)"/>.</param>
        /// <remarks>
        ...
        /// driver.</para>
        /// </remarks>
        /// <seealso cref="SwapBuffers(GLFW.Window)"/>
        ...
        [DllImport(Library, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi, EntryPoint = "glfwExtensionSupported"), SuppressUnmanagedCodeSecurity]
        [return: MarshalAs(UnmanagedType.Bool)]
        ...
        [DllImport(Library, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi, EntryPoint = "glfwGetProcAddress"), SuppressUnmanagedCodeSecurity]
        ...
        [DllImport(Library, CallingConvention = CallingConvention.Cdecl, EntryPoint = "glfwVulkanSupported"), SuppressUnmanagedCodeSecurity]
        [return: MarshalAs(UnmanagedType.Bool)]

...
namespace AlienEngine.Core.Threading
{
    ...
    public static class Parallel
    {
        ...
        public static void RunCallbacks()
        {
            ...
            for (int i = 0, l = callbackBuffer.Count; i < l; i++)
            {
        ...
        public static int[] ProcessorAffinity
        {
            ...
            set
            {
                ...
                if (value.Any(id => id < 0))
                    throw new ArgumentException("The processor affinity must not be negative.", nameof(value));
        ...
        /// </exception>
        public static Task StartBackground(IWork work, Action completionCallback = null)
        {
            if (work == null)
        ...
        /// </exception>
        public static Task StartBackground(Action action, Action completionCallback = null)
        {
            if (action == null)
        ...
        /// Invalid number of maximum threads set in <see cref="IWork.Options"/>.
        /// </exception>
        public static Task Start(IWork work, Action completionCallback = null)
        {
            if (work == null)
                throw new ArgumentNullException(nameof(work));
        ...
        /// <param name="completionCallback">A method which will be called in Parallel.RunCallbacks() once this task has completed.</param>
        /// <returns>A task which represents one execution of the work.</returns>
        public static Task Start(Action action, Action completionCallback = null)
        {
        ...
        /// <param name="completionCallback">A method which will be called in Parallel.RunCallbacks() once this task has completed.</param>
        /// <returns>A task which represents one execution of the work.</returns>
        public static Task Start(Action action, WorkOptions options, Action completionCallback = null)
        {
        ...
        public static Future<T> Start<T>(Func<T> function, Action completionCallback = null)
        {

...
namespace AlienEngine
{
    ...
    public static class MathChecker
    {
        ...
        /// </summary>
        [Conditional("CHECKMATH")]
        public static void Validate(this Vector3f v)
        {
        ...
        /// </summary>
        [Conditional("CHECKMATH")]
        public static void Validate(this Matrix2x3f m)
        {
        ...
        /// </summary>
        [Conditional("CHECKMATH")]
        public static void Validate(this Matrix3f m)
        {
            m.Right.Validate();
            m.Up.Validate();
            m.Backward.Validate();
        ...
        /// </summary>
        [Conditional("CHECKMATH")]
        public static void Validate(this Matrix4f m)
        {
            m.Right.Validate();
            m.Up.Validate();
            m.Backward.Validate();

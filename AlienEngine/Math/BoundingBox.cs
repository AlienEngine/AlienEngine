...
{
    /// <summary>
    /// Provides axis-aligned bounding box functionality.
    /// </summary>
    public struct BoundingBox
    {
        ...
        {
            var toReturn = new Vector3f[8];
            toReturn[0] = new Vector3f(Min.X, Max.Y, Max.Z);
            toReturn[1] = Max;
            toReturn[2] = new Vector3f(Max.X, Min.Y, Max.Z);
            toReturn[3] = new Vector3f(Min.X, Min.Y, Max.Z);
            toReturn[4] = new Vector3f(Min.X, Max.Y, Min.Z);
            toReturn[5] = new Vector3f(Max.X, Max.Y, Min.Z);
            toReturn[6] = new Vector3f(Max.X, Min.Y, Min.Z);
            toReturn[7] = Min;
            return toReturn;
        }
        ...
        public void Intersects(ref BoundingSphere boundingSphere, out bool intersects)
        {
            ...
            float distanceSquared = (clampedLocation - boundingSphere.Center).LengthSquared;

...
namespace AlienEngine.Core.Audio.OpenAL
{
    ...
    public static class Alc
    {
        ...
        unsafe internal static ContextHandle CreateContext([In] IntPtr device, [In] int* attrlist)
        {
        ...
        internal static ContextHandle CreateContext(IntPtr device, int[] attriblist)
        {
            unsafe
            {
        ...
        internal static bool MakeContextCurrent(ContextHandle context)
        {
        ...
        /// <param name="context">a pointer to the new context</param>
        internal static void ProcessContext(ContextHandle context)
        {
        ...
        internal static void SuspendContext(ContextHandle context)
        {
        ...
        /// <param name="context">a pointer to the new context.</param>
        internal static void DestroyContext(ContextHandle context)
        {
        ...
        internal static ContextHandle GetCurrentContext()
        {
        ...
        internal static IntPtr GetContextsDevice(ContextHandle context)
        {
